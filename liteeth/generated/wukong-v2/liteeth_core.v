...
│    │    └─── liteethphygmiitx_0* (LiteEthPHYGMIITX)
│    │    └─── liteethphymiitx_0* (LiteEthPHYMIITX)
│    │    │    └─── converter (Converter)
...
reg     [1:0] builder_liteethphygmiimii_next_state = 2'd0;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *)
reg     [5:0] builder_xilinxmultiregimpl30 = 6'd0;
(* async_reg = "true", dont_touch = "true" *)
reg     [5:0] builder_xilinxmultiregimpl31 = 6'd0;
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *)
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *)
reg     [5:0] builder_xilinxmultiregimpl70 = 6'd0;
(* async_reg = "true", dont_touch = "true" *)
reg     [5:0] builder_xilinxmultiregimpl71 = 6'd0;
(* dont_touch = "true" *)
wire          eth_rx_clk;
wire          eth_rx_rst;
(* dont_touch = "true" *)
...
reg           main_maccore_ethphy_demux_endpoint0_source_first = 1'd0;
reg           main_maccore_ethphy_demux_endpoint0_source_last = 1'd0;
reg     [7:0] main_maccore_ethphy_demux_endpoint0_source_payload_data = 8'd0;
reg           main_maccore_ethphy_demux_endpoint0_source_payload_error = 1'd0;
reg           main_maccore_ethphy_demux_endpoint0_source_payload_last_be = 1'd0;
wire          main_maccore_ethphy_demux_endpoint0_source_ready;
reg           main_maccore_ethphy_demux_endpoint0_source_valid = 1'd0;
reg           main_maccore_ethphy_demux_endpoint1_source_first = 1'd0;
reg           main_maccore_ethphy_demux_endpoint1_source_last = 1'd0;
reg     [7:0] main_maccore_ethphy_demux_endpoint1_source_payload_data = 8'd0;
reg           main_maccore_ethphy_demux_endpoint1_source_payload_error = 1'd0;
reg           main_maccore_ethphy_demux_endpoint1_source_payload_last_be = 1'd0;
wire          main_maccore_ethphy_demux_endpoint1_source_ready;
reg           main_maccore_ethphy_demux_endpoint1_source_valid = 1'd0;
wire          main_maccore_ethphy_demux_sel;
wire          main_maccore_ethphy_demux_sink_first;
wire          main_maccore_ethphy_demux_sink_last;
wire    [7:0] main_maccore_ethphy_demux_sink_payload_data;
wire          main_maccore_ethphy_demux_sink_payload_error;
wire          main_maccore_ethphy_demux_sink_payload_last_be;
reg           main_maccore_ethphy_demux_sink_ready = 1'd0;
wire          main_maccore_ethphy_demux_sink_valid;
reg     [9:0] main_maccore_ethphy_eth_counter = 10'd0;
wire          main_maccore_ethphy_eth_tick;
reg           main_maccore_ethphy_eth_tx_clk = 1'd0;
reg           main_maccore_ethphy_gmii_rx_dv_d = 1'd0;
reg           main_maccore_ethphy_gmii_rx_source_first = 1'd0;
wire          main_maccore_ethphy_gmii_rx_source_last;
reg     [7:0] main_maccore_ethphy_gmii_rx_source_payload_data = 8'd0;
reg           main_maccore_ethphy_gmii_rx_source_payload_error = 1'd0;
reg           main_maccore_ethphy_gmii_rx_source_payload_last_be = 1'd0;
wire          main_maccore_ethphy_gmii_rx_source_ready;
reg           main_maccore_ethphy_gmii_rx_source_valid = 1'd0;
reg     [7:0] main_maccore_ethphy_gmii_tx_pads_tx_data = 8'd0;
reg           main_maccore_ethphy_gmii_tx_pads_tx_en = 1'd0;
reg           main_maccore_ethphy_gmii_tx_pads_tx_er = 1'd0;
wire          main_maccore_ethphy_gmii_tx_sink_first;
wire          main_maccore_ethphy_gmii_tx_sink_last;
wire    [7:0] main_maccore_ethphy_gmii_tx_sink_payload_data;
wire          main_maccore_ethphy_gmii_tx_sink_payload_error;
wire          main_maccore_ethphy_gmii_tx_sink_payload_last_be;
reg           main_maccore_ethphy_gmii_tx_sink_ready = 1'd0;
wire          main_maccore_ethphy_gmii_tx_sink_valid;
wire          main_maccore_ethphy_i;
wire          main_maccore_ethphy_mdc;
reg           main_maccore_ethphy_mii_rx_converter_demux = 1'd0;
wire          main_maccore_ethphy_mii_rx_converter_load_part;
reg           main_maccore_ethphy_mii_rx_converter_sink_first = 1'd0;
wire          main_maccore_ethphy_mii_rx_converter_sink_last;
reg     [3:0] main_maccore_ethphy_mii_rx_converter_sink_payload_data = 4'd0;
wire          main_maccore_ethphy_mii_rx_converter_sink_ready;
reg           main_maccore_ethphy_mii_rx_converter_sink_valid = 1'd0;
reg           main_maccore_ethphy_mii_rx_converter_source_first = 1'd0;
reg           main_maccore_ethphy_mii_rx_converter_source_last = 1'd0;
reg     [7:0] main_maccore_ethphy_mii_rx_converter_source_payload_data = 8'd0;
reg     [1:0] main_maccore_ethphy_mii_rx_converter_source_payload_valid_token_count = 2'd0;
wire          main_maccore_ethphy_mii_rx_converter_source_ready;
wire          main_maccore_ethphy_mii_rx_converter_source_valid;
reg           main_maccore_ethphy_mii_rx_converter_strobe_all = 1'd0;
reg           main_maccore_ethphy_mii_rx_reset = 1'd0;
wire          main_maccore_ethphy_mii_rx_source_first;
wire          main_maccore_ethphy_mii_rx_source_last;
wire    [7:0] main_maccore_ethphy_mii_rx_source_payload_data;
reg           main_maccore_ethphy_mii_rx_source_payload_error = 1'd0;
reg           main_maccore_ethphy_mii_rx_source_payload_last_be = 1'd0;
wire          main_maccore_ethphy_mii_rx_source_ready;
wire          main_maccore_ethphy_mii_rx_source_source_first;
wire          main_maccore_ethphy_mii_rx_source_source_last;
wire    [7:0] main_maccore_ethphy_mii_rx_source_source_payload_data;
wire          main_maccore_ethphy_mii_rx_source_source_ready;
wire          main_maccore_ethphy_mii_rx_source_source_valid;
wire          main_maccore_ethphy_mii_rx_source_valid;
wire          main_maccore_ethphy_mii_tx_converter_first;
wire          main_maccore_ethphy_mii_tx_converter_last;
reg           main_maccore_ethphy_mii_tx_converter_mux = 1'd0;
reg           main_maccore_ethphy_mii_tx_converter_sink_first = 1'd0;
reg           main_maccore_ethphy_mii_tx_converter_sink_last = 1'd0;
wire    [7:0] main_maccore_ethphy_mii_tx_converter_sink_payload_data;
wire          main_maccore_ethphy_mii_tx_converter_sink_ready;
wire          main_maccore_ethphy_mii_tx_converter_sink_valid;
wire          main_maccore_ethphy_mii_tx_converter_source_first;
wire          main_maccore_ethphy_mii_tx_converter_source_last;
reg     [3:0] main_maccore_ethphy_mii_tx_converter_source_payload_data = 4'd0;
wire          main_maccore_ethphy_mii_tx_converter_source_payload_valid_token_count;
wire          main_maccore_ethphy_mii_tx_converter_source_ready;
wire          main_maccore_ethphy_mii_tx_converter_source_valid;
reg     [7:0] main_maccore_ethphy_mii_tx_pads_tx_data = 8'd0;
reg           main_maccore_ethphy_mii_tx_pads_tx_en = 1'd0;
reg           main_maccore_ethphy_mii_tx_pads_tx_er = 1'd0;
wire          main_maccore_ethphy_mii_tx_sink_first;
wire          main_maccore_ethphy_mii_tx_sink_last;
wire    [7:0] main_maccore_ethphy_mii_tx_sink_payload_data;
wire          main_maccore_ethphy_mii_tx_sink_payload_error;
wire          main_maccore_ethphy_mii_tx_sink_payload_last_be;
wire          main_maccore_ethphy_mii_tx_sink_ready;
wire          main_maccore_ethphy_mii_tx_sink_valid;
wire          main_maccore_ethphy_mii_tx_source_source_first;
wire          main_maccore_ethphy_mii_tx_source_source_last;
wire    [3:0] main_maccore_ethphy_mii_tx_source_source_payload_data;
wire          main_maccore_ethphy_mii_tx_source_source_ready;
wire          main_maccore_ethphy_mii_tx_source_source_valid;
...
wire          main_maccore_ethphy_mux_endpoint0_sink_first;
wire          main_maccore_ethphy_mux_endpoint0_sink_last;
wire    [7:0] main_maccore_ethphy_mux_endpoint0_sink_payload_data;
wire          main_maccore_ethphy_mux_endpoint0_sink_payload_error;
wire          main_maccore_ethphy_mux_endpoint0_sink_payload_last_be;
reg           main_maccore_ethphy_mux_endpoint0_sink_ready = 1'd0;
wire          main_maccore_ethphy_mux_endpoint0_sink_valid;
wire          main_maccore_ethphy_mux_endpoint1_sink_first;
wire          main_maccore_ethphy_mux_endpoint1_sink_last;
wire    [7:0] main_maccore_ethphy_mux_endpoint1_sink_payload_data;
wire          main_maccore_ethphy_mux_endpoint1_sink_payload_error;
wire          main_maccore_ethphy_mux_endpoint1_sink_payload_last_be;
reg           main_maccore_ethphy_mux_endpoint1_sink_ready = 1'd0;
wire          main_maccore_ethphy_mux_endpoint1_sink_valid;
wire          main_maccore_ethphy_mux_sel;
reg           main_maccore_ethphy_mux_source_first = 1'd0;
reg           main_maccore_ethphy_mux_source_last = 1'd0;
reg     [7:0] main_maccore_ethphy_mux_source_payload_data = 8'd0;
reg           main_maccore_ethphy_mux_source_payload_error = 1'd0;
reg           main_maccore_ethphy_mux_source_payload_last_be = 1'd0;
wire          main_maccore_ethphy_mux_source_ready;
reg           main_maccore_ethphy_mux_source_valid = 1'd0;
wire          main_maccore_ethphy_o;
wire          main_maccore_ethphy_oe;
reg     [7:0] main_maccore_ethphy_pads_d_rx_data = 8'd0;
reg           main_maccore_ethphy_pads_d_rx_dv = 1'd0;
...
wire          main_maccore_ethphy_sink_sink_first;
wire          main_maccore_ethphy_sink_sink_last;
wire    [7:0] main_maccore_ethphy_sink_sink_payload_data;
wire          main_maccore_ethphy_sink_sink_payload_error;
wire          main_maccore_ethphy_sink_sink_payload_last_be;
wire          main_maccore_ethphy_sink_sink_ready;
wire          main_maccore_ethphy_sink_sink_valid;
wire          main_maccore_ethphy_source_source_first;
wire          main_maccore_ethphy_source_source_last;
wire    [7:0] main_maccore_ethphy_source_source_payload_data;
wire          main_maccore_ethphy_source_source_payload_error;
wire          main_maccore_ethphy_source_source_payload_last_be;
wire          main_maccore_ethphy_source_source_ready;
wire          main_maccore_ethphy_source_source_valid;
...
always @(*) begin
    ...
    if ((main_maccore_ethphy_mode0 == 1'd1)) begin
        main_maccore_ethphy_eth_tx_clk <= gmii_clocks_tx;
    end else begin
        main_maccore_ethphy_eth_tx_clk <= gmii_clocks_rx;
    end
end
assign main_maccore_ethphy_reset0 = (main_maccore_ethphy_reset_storage | main_maccore_ethphy_reset1);
assign gmii_rst_n = (~main_maccore_ethphy_reset0);
...
assign main_maccore_ethphy_demux_sel = (main_maccore_ethphy_mode0 == 1'd1);
assign main_maccore_ethphy_demux_sink_valid = main_maccore_ethphy_sink_sink_valid;
assign main_maccore_ethphy_sink_sink_ready = main_maccore_ethphy_demux_sink_ready;
assign main_maccore_ethphy_demux_sink_first = main_maccore_ethphy_sink_sink_first;
assign main_maccore_ethphy_demux_sink_last = main_maccore_ethphy_sink_sink_last;
assign main_maccore_ethphy_demux_sink_payload_data = main_maccore_ethphy_sink_sink_payload_data;
assign main_maccore_ethphy_demux_sink_payload_last_be = main_maccore_ethphy_sink_sink_payload_last_be;
assign main_maccore_ethphy_demux_sink_payload_error = main_maccore_ethphy_sink_sink_payload_error;
assign main_maccore_ethphy_gmii_tx_sink_valid = main_maccore_ethphy_demux_endpoint0_source_valid;
assign main_maccore_ethphy_demux_endpoint0_source_ready = main_maccore_ethphy_gmii_tx_sink_ready;
assign main_maccore_ethphy_gmii_tx_sink_first = main_maccore_ethphy_demux_endpoint0_source_first;
assign main_maccore_ethphy_gmii_tx_sink_last = main_maccore_ethphy_demux_endpoint0_source_last;
assign main_maccore_ethphy_gmii_tx_sink_payload_data = main_maccore_ethphy_demux_endpoint0_source_payload_data;
assign main_maccore_ethphy_gmii_tx_sink_payload_last_be = main_maccore_ethphy_demux_endpoint0_source_payload_last_be;
assign main_maccore_ethphy_gmii_tx_sink_payload_error = main_maccore_ethphy_demux_endpoint0_source_payload_error;
assign main_maccore_ethphy_mii_tx_sink_valid = main_maccore_ethphy_demux_endpoint1_source_valid;
assign main_maccore_ethphy_demux_endpoint1_source_ready = main_maccore_ethphy_mii_tx_sink_ready;
assign main_maccore_ethphy_mii_tx_sink_first = main_maccore_ethphy_demux_endpoint1_source_first;
...
assign main_maccore_ethphy_mii_tx_sink_payload_last_be = main_maccore_ethphy_demux_endpoint1_source_payload_last_be;
assign main_maccore_ethphy_mii_tx_sink_payload_error = main_maccore_ethphy_demux_endpoint1_source_payload_error;
assign gmii_tx_er = 1'd0;
assign main_maccore_ethphy_mii_tx_converter_sink_valid = main_maccore_ethphy_mii_tx_sink_valid;
assign main_maccore_ethphy_mii_tx_converter_sink_payload_data = main_maccore_ethphy_mii_tx_sink_payload_data;
assign main_maccore_ethphy_mii_tx_sink_ready = main_maccore_ethphy_mii_tx_converter_sink_ready;
assign main_maccore_ethphy_mii_tx_source_source_ready = 1'd1;
assign main_maccore_ethphy_mii_tx_source_source_valid = main_maccore_ethphy_mii_tx_converter_source_valid;
assign main_maccore_ethphy_mii_tx_converter_source_ready = main_maccore_ethphy_mii_tx_source_source_ready;
assign main_maccore_ethphy_mii_tx_source_source_first = main_maccore_ethphy_mii_tx_converter_source_first;
assign main_maccore_ethphy_mii_tx_source_source_last = main_maccore_ethphy_mii_tx_converter_source_last;
assign main_maccore_ethphy_mii_tx_source_source_payload_data = main_maccore_ethphy_mii_tx_converter_source_payload_data;
assign main_maccore_ethphy_mii_tx_converter_first = (main_maccore_ethphy_mii_tx_converter_mux == 1'd0);
assign main_maccore_ethphy_mii_tx_converter_last = (main_maccore_ethphy_mii_tx_converter_mux == 1'd1);
assign main_maccore_ethphy_mii_tx_converter_source_valid = main_maccore_ethphy_mii_tx_converter_sink_valid;
assign main_maccore_ethphy_mii_tx_converter_source_first = (main_maccore_ethphy_mii_tx_converter_sink_first & main_maccore_ethphy_mii_tx_converter_first);
assign main_maccore_ethphy_mii_tx_converter_source_last = (main_maccore_ethphy_mii_tx_converter_sink_last & main_maccore_ethphy_mii_tx_converter_last);
assign main_maccore_ethphy_mii_tx_converter_sink_ready = (main_maccore_ethphy_mii_tx_converter_last & main_maccore_ethphy_mii_tx_converter_source_ready);
always @(*) begin
    main_maccore_ethphy_mii_tx_converter_source_payload_data <= 4'd0;
    case (main_maccore_ethphy_mii_tx_converter_mux)
        1'd0: begin
            main_maccore_ethphy_mii_tx_converter_source_payload_data <= main_maccore_ethphy_mii_tx_converter_sink_payload_data[3:0];
        end
        default: begin
            main_maccore_ethphy_mii_tx_converter_source_payload_data <= main_maccore_ethphy_mii_tx_converter_sink_payload_data[7:4];
        end
    endcase
end
assign main_maccore_ethphy_mii_tx_converter_source_payload_valid_token_count = main_maccore_ethphy_mii_tx_converter_last;
always @(*) begin
    main_maccore_ethphy_demux_endpoint0_source_first <= 1'd0;
    main_maccore_ethphy_demux_endpoint0_source_last <= 1'd0;
    main_maccore_ethphy_demux_endpoint0_source_payload_data <= 8'd0;
    main_maccore_ethphy_demux_endpoint0_source_payload_error <= 1'd0;
    main_maccore_ethphy_demux_endpoint0_source_payload_last_be <= 1'd0;
    main_maccore_ethphy_demux_endpoint0_source_valid <= 1'd0;
    main_maccore_ethphy_demux_endpoint1_source_first <= 1'd0;
    main_maccore_ethphy_demux_endpoint1_source_last <= 1'd0;
    main_maccore_ethphy_demux_endpoint1_source_payload_data <= 8'd0;
    main_maccore_ethphy_demux_endpoint1_source_payload_error <= 1'd0;
    main_maccore_ethphy_demux_endpoint1_source_payload_last_be <= 1'd0;
    main_maccore_ethphy_demux_endpoint1_source_valid <= 1'd0;
    main_maccore_ethphy_demux_sink_ready <= 1'd0;
    case (main_maccore_ethphy_demux_sel)
        1'd0: begin
            main_maccore_ethphy_demux_endpoint0_source_valid <= main_maccore_ethphy_demux_sink_valid;
            main_maccore_ethphy_demux_sink_ready <= main_maccore_ethphy_demux_endpoint0_source_ready;
            main_maccore_ethphy_demux_endpoint0_source_first <= main_maccore_ethphy_demux_sink_first;
            main_maccore_ethphy_demux_endpoint0_source_last <= main_maccore_ethphy_demux_sink_last;
            main_maccore_ethphy_demux_endpoint0_source_payload_data <= main_maccore_ethphy_demux_sink_payload_data;
        ...
        1'd1: begin
            main_maccore_ethphy_demux_endpoint1_source_valid <= main_maccore_ethphy_demux_sink_valid;
            main_maccore_ethphy_demux_sink_ready <= main_maccore_ethphy_demux_endpoint1_source_ready;
            main_maccore_ethphy_demux_endpoint1_source_first <= main_maccore_ethphy_demux_sink_first;
            main_maccore_ethphy_demux_endpoint1_source_last <= main_maccore_ethphy_demux_sink_last;
            main_maccore_ethphy_demux_endpoint1_source_payload_data <= main_maccore_ethphy_demux_sink_payload_data;
            main_maccore_ethphy_demux_endpoint1_source_payload_last_be <= main_maccore_ethphy_demux_sink_payload_last_be;
            main_maccore_ethphy_demux_endpoint1_source_payload_error <= main_maccore_ethphy_demux_sink_payload_error;
        end
    endcase
end
assign main_maccore_ethphy_mux_sel = (main_maccore_ethphy_mode0 == 1'd1);
assign main_maccore_ethphy_mux_endpoint0_sink_valid = main_maccore_ethphy_gmii_rx_source_valid;
assign main_maccore_ethphy_gmii_rx_source_ready = main_maccore_ethphy_mux_endpoint0_sink_ready;
assign main_maccore_ethphy_mux_endpoint0_sink_first = main_maccore_ethphy_gmii_rx_source_first;
assign main_maccore_ethphy_mux_endpoint0_sink_last = main_maccore_ethphy_gmii_rx_source_last;
assign main_maccore_ethphy_mux_endpoint0_sink_payload_data = main_maccore_ethphy_gmii_rx_source_payload_data;
assign main_maccore_ethphy_mux_endpoint0_sink_payload_last_be = main_maccore_ethphy_gmii_rx_source_payload_last_be;
assign main_maccore_ethphy_mux_endpoint0_sink_payload_error = main_maccore_ethphy_gmii_rx_source_payload_error;
...
assign main_maccore_ethphy_mux_endpoint1_sink_last = main_maccore_ethphy_mii_rx_source_last;
assign main_maccore_ethphy_mux_endpoint1_sink_payload_data = main_maccore_ethphy_mii_rx_source_payload_data;
assign main_maccore_ethphy_mux_endpoint1_sink_payload_last_be = main_maccore_ethphy_mii_rx_source_payload_last_be;
assign main_maccore_ethphy_mux_endpoint1_sink_payload_error = main_maccore_ethphy_mii_rx_source_payload_error;
assign main_maccore_ethphy_source_source_valid = main_maccore_ethphy_mux_source_valid;
assign main_maccore_ethphy_mux_source_ready = main_maccore_ethphy_source_source_ready;
assign main_maccore_ethphy_source_source_first = main_maccore_ethphy_mux_source_first;
assign main_maccore_ethphy_source_source_last = main_maccore_ethphy_mux_source_last;
assign main_maccore_ethphy_source_source_payload_data = main_maccore_ethphy_mux_source_payload_data;
assign main_maccore_ethphy_source_source_payload_last_be = main_maccore_ethphy_mux_source_payload_last_be;
assign main_maccore_ethphy_source_source_payload_error = main_maccore_ethphy_mux_source_payload_error;
assign main_maccore_ethphy_gmii_rx_source_last = ((~main_maccore_ethphy_pads_d_rx_dv) & main_maccore_ethphy_gmii_rx_dv_d);
assign main_maccore_ethphy_mii_rx_converter_sink_last = (~main_maccore_ethphy_pads_d_rx_dv);
assign main_maccore_ethphy_mii_rx_source_valid = main_maccore_ethphy_mii_rx_source_source_valid;
assign main_maccore_ethphy_mii_rx_source_source_ready = main_maccore_ethphy_mii_rx_source_ready;
assign main_maccore_ethphy_mii_rx_source_first = main_maccore_ethphy_mii_rx_source_source_first;
assign main_maccore_ethphy_mii_rx_source_last = main_maccore_ethphy_mii_rx_source_source_last;
assign main_maccore_ethphy_mii_rx_source_payload_data = main_maccore_ethphy_mii_rx_source_source_payload_data;
assign main_maccore_ethphy_mii_rx_source_source_valid = main_maccore_ethphy_mii_rx_converter_source_valid;
assign main_maccore_ethphy_mii_rx_converter_source_ready = main_maccore_ethphy_mii_rx_source_source_ready;
...
assign main_maccore_ethphy_mii_rx_source_source_payload_data = main_maccore_ethphy_mii_rx_converter_source_payload_data;
assign main_maccore_ethphy_mii_rx_converter_sink_ready = ((~main_maccore_ethphy_mii_rx_converter_strobe_all) | main_maccore_ethphy_mii_rx_converter_source_ready);
assign main_maccore_ethphy_mii_rx_converter_source_valid = main_maccore_ethphy_mii_rx_converter_strobe_all;
assign main_maccore_ethphy_mii_rx_converter_load_part = (main_maccore_ethphy_mii_rx_converter_sink_valid & main_maccore_ethphy_mii_rx_converter_sink_ready);
always @(*) begin
    main_maccore_ethphy_mux_endpoint0_sink_ready <= 1'd0;
    main_maccore_ethphy_mux_endpoint1_sink_ready <= 1'd0;
    main_maccore_ethphy_mux_source_first <= 1'd0;
    main_maccore_ethphy_mux_source_last <= 1'd0;
    main_maccore_ethphy_mux_source_payload_data <= 8'd0;
    main_maccore_ethphy_mux_source_payload_error <= 1'd0;
    main_maccore_ethphy_mux_source_payload_last_be <= 1'd0;
    main_maccore_ethphy_mux_source_valid <= 1'd0;
    case (main_maccore_ethphy_mux_sel)
        1'd0: begin
            main_maccore_ethphy_mux_source_valid <= main_maccore_ethphy_mux_endpoint0_sink_valid;
            main_maccore_ethphy_mux_endpoint0_sink_ready <= main_maccore_ethphy_mux_source_ready;
            main_maccore_ethphy_mux_source_first <= main_maccore_ethphy_mux_endpoint0_sink_first;
            main_maccore_ethphy_mux_source_last <= main_maccore_ethphy_mux_endpoint0_sink_last;
            main_maccore_ethphy_mux_source_payload_data <= main_maccore_ethphy_mux_endpoint0_sink_payload_data;
            main_maccore_ethphy_mux_source_payload_last_be <= main_maccore_ethphy_mux_endpoint0_sink_payload_last_be;
            main_maccore_ethphy_mux_source_payload_error <= main_maccore_ethphy_mux_endpoint0_sink_payload_error;
        end
        1'd1: begin
            main_maccore_ethphy_mux_source_valid <= main_maccore_ethphy_mux_endpoint1_sink_valid;
            main_maccore_ethphy_mux_endpoint1_sink_ready <= main_maccore_ethphy_mux_source_ready;
            main_maccore_ethphy_mux_source_first <= main_maccore_ethphy_mux_endpoint1_sink_first;
            main_maccore_ethphy_mux_source_last <= main_maccore_ethphy_mux_endpoint1_sink_last;
            main_maccore_ethphy_mux_source_payload_data <= main_maccore_ethphy_mux_endpoint1_sink_payload_data;
            main_maccore_ethphy_mux_source_payload_last_be <= main_maccore_ethphy_mux_endpoint1_sink_payload_last_be;
            main_maccore_ethphy_mux_source_payload_error <= main_maccore_ethphy_mux_endpoint1_sink_payload_error;
        end
    endcase
end
assign gmii_mdc = main_maccore_ethphy__w_storage[0];
...
assign main_maccore_ethphy_sink_sink_valid = main_tx_gap_source_valid;
assign main_tx_gap_source_ready = main_maccore_ethphy_sink_sink_ready;
assign main_maccore_ethphy_sink_sink_first = main_tx_gap_source_first;
assign main_maccore_ethphy_sink_sink_last = main_tx_gap_source_last;
assign main_maccore_ethphy_sink_sink_payload_data = main_tx_gap_source_payload_data;
assign main_maccore_ethphy_sink_sink_payload_last_be = main_tx_gap_source_payload_last_be;
assign main_maccore_ethphy_sink_sink_payload_error = main_tx_gap_source_payload_error;
...
assign main_rx_preamble_sink_valid = main_maccore_ethphy_source_source_valid;
assign main_maccore_ethphy_source_source_ready = main_rx_preamble_sink_ready;
assign main_rx_preamble_sink_first = main_maccore_ethphy_source_source_first;
assign main_rx_preamble_sink_last = main_maccore_ethphy_source_source_last;
assign main_rx_preamble_sink_payload_data = main_maccore_ethphy_source_source_payload_data;
assign main_rx_preamble_sink_payload_last_be = main_maccore_ethphy_source_source_payload_last_be;
...
assign main_maccore_ethphy_toggle_o = builder_xilinxmultiregimpl01;
always @(*) begin
    main_maccore_ethphy__r_status <= 1'd0;
    main_maccore_ethphy__r_status <= main_maccore_ethphy_r;
    main_maccore_ethphy__r_status <= builder_xilinxmultiregimpl11;
end
assign main_tx_cdc_cdc_produce_rdomain = builder_xilinxmultiregimpl21;
assign main_tx_cdc_cdc_consume_wdomain = builder_xilinxmultiregimpl31;
assign main_pulsesynchronizer0_toggle_o = builder_xilinxmultiregimpl41;
assign main_pulsesynchronizer1_toggle_o = builder_xilinxmultiregimpl51;
assign main_rx_cdc_cdc_produce_rdomain = builder_xilinxmultiregimpl61;
assign main_rx_cdc_cdc_consume_wdomain = builder_xilinxmultiregimpl71;
...
always @(posedge eth_rx_clk) begin
    ...
    main_maccore_ethphy_pads_d_rx_dv <= gmii_rx_dv;
    main_maccore_ethphy_pads_d_rx_data <= gmii_rx_data;
    main_maccore_ethphy_gmii_rx_dv_d <= main_maccore_ethphy_pads_d_rx_dv;
    main_maccore_ethphy_gmii_rx_source_valid <= main_maccore_ethphy_pads_d_rx_dv;
    main_maccore_ethphy_gmii_rx_source_payload_data <= main_maccore_ethphy_pads_d_rx_data;
    main_maccore_ethphy_mii_rx_reset <= (~main_maccore_ethphy_pads_d_rx_dv);
    main_maccore_ethphy_mii_rx_converter_sink_valid <= 1'd1;
    main_maccore_ethphy_mii_rx_converter_sink_payload_data <= main_maccore_ethphy_pads_d_rx_data;
    if (main_maccore_ethphy_mii_rx_converter_source_ready) begin
        main_maccore_ethphy_mii_rx_converter_strobe_all <= 1'd0;
    end
    if (main_maccore_ethphy_mii_rx_converter_load_part) begin
        if (((main_maccore_ethphy_mii_rx_converter_demux == 1'd1) | main_maccore_ethphy_mii_rx_converter_sink_last)) begin
            main_maccore_ethphy_mii_rx_converter_demux <= 1'd0;
            main_maccore_ethphy_mii_rx_converter_strobe_all <= 1'd1;
        end else begin
            main_maccore_ethphy_mii_rx_converter_demux <= (main_maccore_ethphy_mii_rx_converter_demux + 1'd1);
        end
    end
    if ((main_maccore_ethphy_mii_rx_converter_source_valid & main_maccore_ethphy_mii_rx_converter_source_ready)) begin
        if ((main_maccore_ethphy_mii_rx_converter_sink_valid & main_maccore_ethphy_mii_rx_converter_sink_ready)) begin
            main_maccore_ethphy_mii_rx_converter_source_first <= main_maccore_ethphy_mii_rx_converter_sink_first;
            main_maccore_ethphy_mii_rx_converter_source_last <= main_maccore_ethphy_mii_rx_converter_sink_last;
        end else begin
            main_maccore_ethphy_mii_rx_converter_source_first <= 1'd0;
            main_maccore_ethphy_mii_rx_converter_source_last <= 1'd0;
        end
    end else begin
        if ((main_maccore_ethphy_mii_rx_converter_sink_valid & main_maccore_ethphy_mii_rx_converter_sink_ready)) begin
            main_maccore_ethphy_mii_rx_converter_source_first <= (main_maccore_ethphy_mii_rx_converter_sink_first | main_maccore_ethphy_mii_rx_converter_source_first);
            main_maccore_ethphy_mii_rx_converter_source_last <= (main_maccore_ethphy_mii_rx_converter_sink_last | main_maccore_ethphy_mii_rx_converter_source_last);
        end
    end
    if (main_maccore_ethphy_mii_rx_converter_load_part) begin
        case (main_maccore_ethphy_mii_rx_converter_demux)
            1'd0: begin
                main_maccore_ethphy_mii_rx_converter_source_payload_data[3:0] <= main_maccore_ethphy_mii_rx_converter_sink_payload_data;
            end
            1'd1: begin
                main_maccore_ethphy_mii_rx_converter_source_payload_data[7:4] <= main_maccore_ethphy_mii_rx_converter_sink_payload_data;
            end
        endcase
    end
    if (main_maccore_ethphy_mii_rx_converter_load_part) begin
        main_maccore_ethphy_mii_rx_converter_source_payload_valid_token_count <= (main_maccore_ethphy_mii_rx_converter_demux + 1'd1);
    end
    if (main_maccore_ethphy_mii_rx_reset) begin
        main_maccore_ethphy_mii_rx_converter_source_payload_data <= 8'd0;
        main_maccore_ethphy_mii_rx_converter_source_payload_valid_token_count <= 2'd0;
        main_maccore_ethphy_mii_rx_converter_demux <= 1'd0;
        main_maccore_ethphy_mii_rx_converter_strobe_all <= 1'd0;
    end
    ...
    if (eth_rx_rst) begin
        main_maccore_ethphy_gmii_rx_source_valid <= 1'd0;
        main_maccore_ethphy_gmii_rx_source_payload_data <= 8'd0;
        main_maccore_ethphy_gmii_rx_dv_d <= 1'd0;
        main_maccore_ethphy_mii_rx_converter_sink_valid <= 1'd0;
        main_maccore_ethphy_mii_rx_converter_sink_payload_data <= 4'd0;
        main_maccore_ethphy_mii_rx_converter_source_payload_data <= 8'd0;
        main_maccore_ethphy_mii_rx_converter_source_payload_valid_token_count <= 2'd0;
        main_maccore_ethphy_mii_rx_converter_demux <= 1'd0;
        main_maccore_ethphy_mii_rx_converter_strobe_all <= 1'd0;
        main_maccore_ethphy_mii_rx_reset <= 1'd0;
        main_liteethmaccrc32checker_crc_reg <= 32'd4294967295;
        main_liteethmaccrc32checker_syncfifo_level <= 3'd0;
        main_liteethmaccrc32checker_syncfifo_produce <= 3'd0;
        main_liteethmaccrc32checker_syncfifo_consume <= 3'd0;
    ...
    builder_xilinxmultiregimpl70 <= main_rx_cdc_cdc_graycounter1_q;
    builder_xilinxmultiregimpl71 <= builder_xilinxmultiregimpl70;
end

always @(posedge eth_tx_clk) begin
    if ((main_maccore_ethphy_mode0 == 1'd1)) begin
        gmii_tx_en <= main_maccore_ethphy_mii_tx_pads_tx_en;
        gmii_tx_data <= main_maccore_ethphy_mii_tx_pads_tx_data;
    end else begin
        gmii_tx_en <= main_maccore_ethphy_gmii_tx_pads_tx_en;
        gmii_tx_data <= main_maccore_ethphy_gmii_tx_pads_tx_data;
    end
    main_maccore_ethphy_gmii_tx_pads_tx_er <= 1'd0;
    main_maccore_ethphy_gmii_tx_pads_tx_en <= main_maccore_ethphy_gmii_tx_sink_valid;
    main_maccore_ethphy_gmii_tx_pads_tx_data <= main_maccore_ethphy_gmii_tx_sink_payload_data;
    main_maccore_ethphy_gmii_tx_sink_ready <= 1'd1;
    main_maccore_ethphy_mii_tx_pads_tx_er <= 1'd0;
    main_maccore_ethphy_mii_tx_pads_tx_en <= main_maccore_ethphy_mii_tx_source_source_valid;
    main_maccore_ethphy_mii_tx_pads_tx_data <= main_maccore_ethphy_mii_tx_source_source_payload_data;
    if ((main_maccore_ethphy_mii_tx_converter_source_valid & main_maccore_ethphy_mii_tx_converter_source_ready)) begin
        if (main_maccore_ethphy_mii_tx_converter_last) begin
            main_maccore_ethphy_mii_tx_converter_mux <= 1'd0;
        end else begin
            main_maccore_ethphy_mii_tx_converter_mux <= (main_maccore_ethphy_mii_tx_converter_mux + 1'd1);
        end
    end
    ...
    if (eth_tx_rst) begin
        main_maccore_ethphy_gmii_tx_sink_ready <= 1'd0;
        main_maccore_ethphy_mii_tx_converter_mux <= 1'd0;
    ...
    builder_xilinxmultiregimpl20 <= main_tx_cdc_cdc_graycounter0_q;
...
always @(posedge sys_clk) begin
    ...
    builder_xilinxmultiregimpl00 <= main_maccore_ethphy_toggle_i;
    builder_xilinxmultiregimpl01 <= builder_xilinxmultiregimpl00;
    builder_xilinxmultiregimpl10 <= main_maccore_ethphy_data_r;
    builder_xilinxmultiregimpl11 <= builder_xilinxmultiregimpl10;
    builder_xilinxmultiregimpl30 <= main_tx_cdc_cdc_graycounter1_q;
    builder_xilinxmultiregimpl31 <= builder_xilinxmultiregimpl30;
    builder_xilinxmultiregimpl40 <= main_pulsesynchronizer0_toggle_i;
    builder_xilinxmultiregimpl41 <= builder_xilinxmultiregimpl40;
    builder_xilinxmultiregimpl50 <= main_pulsesynchronizer1_toggle_i;
    builder_xilinxmultiregimpl51 <= builder_xilinxmultiregimpl50;
    builder_xilinxmultiregimpl60 <= main_rx_cdc_cdc_graycounter0_q;
...
assign gmii_mdio = main_maccore_ethphy_data_oe ? main_maccore_ethphy_data_w : 1'bz;
assign main_maccore_ethphy_data_r = gmii_mdio;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-04-05 17:38:50.
//------------------------------------------------------------------------------
