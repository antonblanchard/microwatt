...
reg  main_maccore_ethphy_mode0 = 1'd0;
wire main_maccore_ethphy_mode_status;
wire main_maccore_ethphy_mode_we;
reg  main_maccore_ethphy_mode_re = 1'd0;
reg  main_maccore_ethphy_mode1 = 1'd0;
reg  main_maccore_ethphy_update_mode = 1'd0;
wire main_maccore_ethphy_eth_tick;
reg  [9:0] main_maccore_ethphy_eth_counter = 10'd0;
wire main_maccore_ethphy_sys_tick;
wire main_maccore_ethphy_i;
wire main_maccore_ethphy_o;
reg  main_maccore_ethphy_toggle_i = 1'd0;
wire main_maccore_ethphy_toggle_o;
reg  main_maccore_ethphy_toggle_o_r = 1'd0;
reg  [23:0] main_maccore_ethphy_sys_counter = 24'd0;
reg  main_maccore_ethphy_sys_counter_reset = 1'd0;
reg  main_maccore_ethphy_sys_counter_ce = 1'd0;
...
wire eth_tx_rst;
reg  main_maccore_ethphy_eth_tx_clk = 1'd0;
...
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_first0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_last0;
wire [7:0] main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_last_be0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_error0;
reg  main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_er = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_en = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_data = 8'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_valid;
reg  main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_ready = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_first;
wire main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_last;
wire [7:0] main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_last_be;
wire main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_error;
reg  main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_er = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_en = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_data = 8'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid1;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready1;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_first1;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_last1;
wire [7:0] main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data1;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_last_be1;
wire main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_error1;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_sink_valid;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_sink_ready;
reg  main_maccore_ethphy_liteethphygmiimiitx_converter_sink_first = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_converter_sink_last = 1'd0;
wire [7:0] main_maccore_ethphy_liteethphygmiimiitx_converter_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_valid;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_ready;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_first;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_last;
wire [3:0] main_maccore_ethphy_liteethphygmiimiitx_converter_source_payload_data;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_valid;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_ready;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_first;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_last;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data = 8'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_valid;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_ready;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_first;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_last;
reg  [3:0] main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_data = 4'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_valid_token_count;
reg  main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_first;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_valid;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_ready;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_first;
wire main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_last;
wire [3:0] main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_payload_data;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sink_valid;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_sink_ready = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sink_first;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sink_last;
wire [7:0] main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_last_be;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_error;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_valid = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_ready;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_first = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_last = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_data = 8'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_last_be = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_error = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_valid = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_ready;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_first = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_last = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_data = 8'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_last_be = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_error = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiitx_demux_sel;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_valid0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_ready0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_first0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_last0;
wire [7:0] main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_last_be0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_error0;
reg  main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_data = 8'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_valid = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_ready;
reg  main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_first = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_last;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_data = 8'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_last_be = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_error = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_dv_d = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_valid1;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_ready1;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_first1;
wire main_maccore_ethphy_liteethphygmiimiirx_source_source_last1;
wire [7:0] main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data1;
reg  main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_last_be1 = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_error1 = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_sink_valid = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_sink_ready;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_sink_first = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_sink_last;
reg  [3:0] main_maccore_ethphy_liteethphygmiimiirx_converter_sink_payload_data = 4'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_valid;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_ready;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_first;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_last;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiirx_converter_source_payload_data = 8'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_valid;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_first;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_last;
wire [3:0] main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_valid;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_ready;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data = 8'd0;
reg  [1:0] main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_valid_token_count = 2'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_converter_load_part;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_valid;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_ready;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_first;
wire main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_last;
wire [7:0] main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_payload_data;
reg  main_maccore_ethphy_liteethphygmiimiirx_converter_reset = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_source_valid = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_source_ready;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_source_first = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_source_last = 1'd0;
reg  [7:0] main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_data = 8'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_last_be = 1'd0;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_error = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_valid;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_ready = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_first;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_last;
wire [7:0] main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_last_be;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_error;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_valid;
reg  main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_ready = 1'd0;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_first;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_last;
wire [7:0] main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_data;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_last_be;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_error;
wire main_maccore_ethphy_liteethphygmiimiirx_mux_sel;
...
reg  main_liteethmaccrc32inserter_last_be0 = 1'd0;
reg  [31:0] main_liteethmaccrc32inserter_value = 32'd0;
reg  main_liteethmaccrc32inserter_error = 1'd0;
reg  main_liteethmaccrc32inserter_last_be1 = 1'd0;
...
reg  [31:0] main_liteethmaccrc32inserter_crc_packet = 32'd0;
reg  main_liteethmaccrc32inserter_last_be2 = 1'd0;
...
wire main_bufferizeendpoints_sink_valid;
wire main_bufferizeendpoints_sink_ready;
wire main_bufferizeendpoints_sink_first;
wire main_bufferizeendpoints_sink_last;
wire [7:0] main_bufferizeendpoints_sink_payload_data;
wire main_bufferizeendpoints_sink_payload_last_be;
wire main_bufferizeendpoints_sink_payload_error;
reg  main_bufferizeendpoints_source_valid = 1'd0;
wire main_bufferizeendpoints_source_ready;
reg  main_bufferizeendpoints_source_first = 1'd0;
reg  main_bufferizeendpoints_source_last = 1'd0;
reg  [7:0] main_bufferizeendpoints_source_payload_data = 8'd0;
reg  main_bufferizeendpoints_source_payload_last_be = 1'd0;
reg  main_bufferizeendpoints_source_payload_error = 1'd0;
...
wire main_rx_crc_sink_sink_valid;
reg  main_rx_crc_sink_sink_ready = 1'd0;
wire main_rx_crc_sink_sink_first;
wire main_rx_crc_sink_sink_last;
wire [7:0] main_rx_crc_sink_sink_payload_data;
wire main_rx_crc_sink_sink_payload_last_be;
wire main_rx_crc_sink_sink_payload_error;
reg  main_rx_crc_source_source_valid = 1'd0;
wire main_rx_crc_source_source_ready;
reg  main_rx_crc_source_source_first = 1'd0;
reg  main_rx_crc_source_source_last = 1'd0;
reg  [7:0] main_rx_crc_source_source_payload_data = 8'd0;
reg  main_rx_crc_source_source_payload_last_be = 1'd0;
reg  main_rx_crc_source_source_payload_error = 1'd0;
reg  main_rx_crc_error = 1'd0;
wire [7:0] main_rx_crc_crc_data0;
wire main_rx_crc_crc_last_be0;
reg  [31:0] main_rx_crc_crc_value = 32'd0;
reg  main_rx_crc_crc_error0 = 1'd0;
reg  main_rx_crc_crc_last_be1 = 1'd0;
wire [7:0] main_rx_crc_crc_data1;
wire [31:0] main_rx_crc_crc_last;
reg  [31:0] main_rx_crc_crc_next = 32'd0;
reg  [31:0] main_rx_crc_crc_reg = 32'd4294967295;
reg  main_rx_crc_crc_ce = 1'd0;
reg  main_rx_crc_crc_reset = 1'd0;
reg  main_rx_crc_syncfifo_sink_valid = 1'd0;
wire main_rx_crc_syncfifo_sink_ready;
wire main_rx_crc_syncfifo_sink_first;
wire main_rx_crc_syncfifo_sink_last;
wire [7:0] main_rx_crc_syncfifo_sink_payload_data;
wire main_rx_crc_syncfifo_sink_payload_last_be;
wire main_rx_crc_syncfifo_sink_payload_error;
wire main_rx_crc_syncfifo_source_valid;
reg  main_rx_crc_syncfifo_source_ready = 1'd0;
wire main_rx_crc_syncfifo_source_first;
wire main_rx_crc_syncfifo_source_last;
wire [7:0] main_rx_crc_syncfifo_source_payload_data;
wire main_rx_crc_syncfifo_source_payload_last_be;
wire main_rx_crc_syncfifo_source_payload_error;
wire main_rx_crc_syncfifo_syncfifo_we;
wire main_rx_crc_syncfifo_syncfifo_writable;
wire main_rx_crc_syncfifo_syncfifo_re;
wire main_rx_crc_syncfifo_syncfifo_readable;
wire [11:0] main_rx_crc_syncfifo_syncfifo_din;
wire [11:0] main_rx_crc_syncfifo_syncfifo_dout;
reg  [2:0] main_rx_crc_syncfifo_level = 3'd0;
reg  main_rx_crc_syncfifo_replace = 1'd0;
reg  [2:0] main_rx_crc_syncfifo_produce = 3'd0;
reg  [2:0] main_rx_crc_syncfifo_consume = 3'd0;
reg  [2:0] main_rx_crc_syncfifo_wrport_adr = 3'd0;
wire [11:0] main_rx_crc_syncfifo_wrport_dat_r;
wire main_rx_crc_syncfifo_wrport_we;
wire [11:0] main_rx_crc_syncfifo_wrport_dat_w;
wire main_rx_crc_syncfifo_do_read;
wire [2:0] main_rx_crc_syncfifo_rdport_adr;
wire [11:0] main_rx_crc_syncfifo_rdport_dat_r;
wire [7:0] main_rx_crc_syncfifo_fifo_in_payload_data;
wire main_rx_crc_syncfifo_fifo_in_payload_last_be;
wire main_rx_crc_syncfifo_fifo_in_payload_error;
wire main_rx_crc_syncfifo_fifo_in_first;
wire main_rx_crc_syncfifo_fifo_in_last;
wire [7:0] main_rx_crc_syncfifo_fifo_out_payload_data;
wire main_rx_crc_syncfifo_fifo_out_payload_last_be;
wire main_rx_crc_syncfifo_fifo_out_payload_error;
wire main_rx_crc_syncfifo_fifo_out_first;
wire main_rx_crc_syncfifo_fifo_out_last;
reg  main_rx_crc_fifo_reset = 1'd0;
wire main_rx_crc_fifo_in;
wire main_rx_crc_fifo_out;
wire main_rx_crc_fifo_full;
reg  main_rx_crc_last_be = 1'd0;
reg  main_rx_crc_crc_error1 = 1'd0;
wire main_rx_crc_sink_valid;
wire main_rx_crc_sink_ready;
wire main_rx_crc_sink_first;
wire main_rx_crc_sink_last;
wire [7:0] main_rx_crc_sink_payload_data;
wire main_rx_crc_sink_payload_last_be;
wire main_rx_crc_sink_payload_error;
reg  main_rx_crc_source_valid = 1'd0;
wire main_rx_crc_source_ready;
reg  main_rx_crc_source_first = 1'd0;
reg  main_rx_crc_source_last = 1'd0;
reg  [7:0] main_rx_crc_source_payload_data = 8'd0;
reg  main_rx_crc_source_payload_last_be = 1'd0;
reg  main_rx_crc_source_payload_error = 1'd0;
...
reg  builder_csrbank2_mode_detection_mode_re = 1'd0;
wire builder_csrbank2_mode_detection_mode_r;
reg  builder_csrbank2_mode_detection_mode_we = 1'd0;
wire builder_csrbank2_mode_detection_mode_w;
...
reg  [1:0] builder_maccore_liteethphygmiimii_state = 2'd0;
reg  [1:0] builder_maccore_liteethphygmiimii_next_state = 2'd0;
...
reg  [31:0] main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value0 = 32'd0;
reg  main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value_ce0 = 1'd0;
reg  main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value1 = 1'd0;
reg  main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value_ce1 = 1'd0;
...
reg  main_rx_crc_last_be_next_value0 = 1'd0;
reg  main_rx_crc_last_be_next_value_ce0 = 1'd0;
reg  main_rx_crc_crc_error1_next_value1 = 1'd0;
reg  main_rx_crc_crc_error1_next_value_ce1 = 1'd0;
reg  [1:0] builder_maccore_liteethmacsramwriter_state = 2'd0;
reg  [1:0] builder_maccore_liteethmacsramwriter_next_state = 2'd0;
...
reg  builder_maccore_wishbone2csr_state = 1'd0;
reg  builder_maccore_wishbone2csr_next_state = 1'd0;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *) reg  [5:0] builder_xilinxmultiregimpl2_regs0 = 6'd0;
(* async_reg = "true", dont_touch = "true" *) reg  [5:0] builder_xilinxmultiregimpl2_regs1 = 6'd0;
...
(* async_reg = "true", mr_ff = "true", dont_touch = "true" *) reg  [5:0] builder_xilinxmultiregimpl7_regs0 = 6'd0;
(* async_reg = "true", dont_touch = "true" *) reg  [5:0] builder_xilinxmultiregimpl7_regs1 = 6'd0;
...
assign main_maccore_ethphy_mode_status = main_maccore_ethphy_mode0;
assign main_maccore_ethphy_eth_tick = (main_maccore_ethphy_eth_counter == 1'd0);
assign main_maccore_ethphy_i = main_maccore_ethphy_eth_tick;
assign main_maccore_ethphy_sys_tick = main_maccore_ethphy_o;
assign main_maccore_ethphy_o = (main_maccore_ethphy_toggle_o ^ main_maccore_ethphy_toggle_o_r);
always @(*) begin
	main_maccore_ethphy_update_mode <= 1'd0;
	main_maccore_ethphy_sys_counter_ce <= 1'd0;
	main_maccore_ethphy_sys_counter_reset <= 1'd0;
	builder_maccore_liteethphygmiimii_next_state <= 2'd0;
	main_maccore_ethphy_mode1 <= 1'd0;
	builder_maccore_liteethphygmiimii_next_state <= builder_maccore_liteethphygmiimii_state;
	case (builder_maccore_liteethphygmiimii_state)
		1'd1: begin
			main_maccore_ethphy_sys_counter_ce <= 1'd1;
			if (main_maccore_ethphy_sys_tick) begin
				builder_maccore_liteethphygmiimii_next_state <= 2'd2;
			end
		end
		2'd2: begin
			main_maccore_ethphy_update_mode <= 1'd1;
			if ((main_maccore_ethphy_sys_counter > 10'd860)) begin
				main_maccore_ethphy_mode1 <= 1'd1;
			end else begin
				main_maccore_ethphy_mode1 <= 1'd0;
			end
			builder_maccore_liteethphygmiimii_next_state <= 1'd0;
		end
		default: begin
			main_maccore_ethphy_sys_counter_reset <= 1'd1;
			if (main_maccore_ethphy_sys_tick) begin
				builder_maccore_liteethphygmiimii_next_state <= 1'd1;
			end
		end
	endcase
end
always @(*) begin
	main_maccore_ethphy_eth_tx_clk <= 1'd0;
	if ((main_maccore_ethphy_mode0 == 1'd1)) begin
		main_maccore_ethphy_eth_tx_clk <= gmii_eth_clocks_tx;
	end else begin
		main_maccore_ethphy_eth_tx_clk <= gmii_eth_clocks_rx;
	end
end
assign main_maccore_ethphy_reset0 = (main_maccore_ethphy_reset_storage | main_maccore_ethphy_reset1);
assign gmii_eth_rst_n = (~main_maccore_ethphy_reset0);
...
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sel = (main_maccore_ethphy_mode0 == 1'd1);
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_valid = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid0;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready0 = main_maccore_ethphy_liteethphygmiimiitx_demux_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_first = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_first0;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_last = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_last0;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_data = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data0;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_last_be = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_last_be0;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_error = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_error0;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_valid = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_ready = main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_first = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_first;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_last = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_last;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_data = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_last_be = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_last_be;
assign main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_error = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_error;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_ready = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready1;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_first1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_first;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_last1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_last;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_last_be1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_last_be;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_error1 = main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_error;
assign gmii_eth_tx_er = 1'd0;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_sink_valid = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid1;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_sink_payload_data = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data1;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready1 = main_maccore_ethphy_liteethphygmiimiitx_converter_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_ready = 1'd1;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_valid = main_maccore_ethphy_liteethphygmiimiitx_converter_sink_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_first = main_maccore_ethphy_liteethphygmiimiitx_converter_sink_first;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_last = main_maccore_ethphy_liteethphygmiimiitx_converter_sink_last;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_sink_ready = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_ready;
always @(*) begin
	main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data <= 8'd0;
	main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data[3:0] <= main_maccore_ethphy_liteethphygmiimiitx_converter_sink_payload_data[3:0];
	main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data[7:4] <= main_maccore_ethphy_liteethphygmiimiitx_converter_sink_payload_data[7:4];
end
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_valid = main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_first = main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_first;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_last = main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_last;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_ready = main_maccore_ethphy_liteethphygmiimiitx_converter_source_ready;
assign {main_maccore_ethphy_liteethphygmiimiitx_converter_source_payload_data} = main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_valid = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_ready = main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_ready;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_first = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_first;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_last = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_last;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_source_source_payload_data = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_first = (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux == 1'd0);
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last = (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux == 1'd1);
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_valid = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_valid;
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_first = (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_first & main_maccore_ethphy_liteethphygmiimiitx_converter_converter_first);
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_last = (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_last & main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last);
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_ready = (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last & main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_ready);
always @(*) begin
	main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_data <= 4'd0;
	case (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux)
		1'd0: begin
			main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_data <= main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data[3:0];
		end
		default: begin
			main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_data <= main_maccore_ethphy_liteethphygmiimiitx_converter_converter_sink_payload_data[7:4];
		end
	endcase
end
assign main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_payload_valid_token_count = main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last;
always @(*) begin
	main_maccore_ethphy_liteethphygmiimiitx_demux_sink_ready <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_last <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_data <= 8'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_last_be <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_error <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_valid <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_first <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_last <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_data <= 8'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_last_be <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_error <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_valid <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_first <= 1'd0;
	case (main_maccore_ethphy_liteethphygmiimiitx_demux_sel)
		1'd0: begin
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_valid <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_valid;
			main_maccore_ethphy_liteethphygmiimiitx_demux_sink_ready <= main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_ready;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_first <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_first;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_last <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_last;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_data <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_data;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_last_be <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_last_be;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint0_source_payload_error <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_error;
		end
		1'd1: begin
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_valid <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_valid;
			main_maccore_ethphy_liteethphygmiimiitx_demux_sink_ready <= main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_ready;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_first <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_first;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_last <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_last;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_data <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_data;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_last_be <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_last_be;
			main_maccore_ethphy_liteethphygmiimiitx_demux_endpoint1_source_payload_error <= main_maccore_ethphy_liteethphygmiimiitx_demux_sink_payload_error;
		end
	endcase
end
assign main_maccore_ethphy_liteethphygmiimiirx_mux_sel = (main_maccore_ethphy_mode0 == 1'd1);
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_valid = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_ready = main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_first = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_first;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_last = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_last;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_data = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_last_be = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_last_be;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_error = main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_error;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_valid = main_maccore_ethphy_liteethphygmiimiirx_source_source_valid1;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_ready1 = main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_first = main_maccore_ethphy_liteethphygmiimiirx_source_source_first1;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_last = main_maccore_ethphy_liteethphygmiimiirx_source_source_last1;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_data = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data1;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_last_be = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_last_be1;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_error = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_error1;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_valid0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_mux_source_ready = main_maccore_ethphy_liteethphygmiimiirx_source_source_ready0;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_first0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_first;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_last0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_last;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_last_be0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_last_be;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_error0 = main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_error;
assign main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_last = ((~main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv) & main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_dv_d);
assign main_maccore_ethphy_liteethphygmiimiirx_converter_sink_last = (~main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv);
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_valid1 = main_maccore_ethphy_liteethphygmiimiirx_converter_source_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_ready = main_maccore_ethphy_liteethphygmiimiirx_source_source_ready1;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_first1 = main_maccore_ethphy_liteethphygmiimiirx_converter_source_first;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_last1 = main_maccore_ethphy_liteethphygmiimiirx_converter_source_last;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data1 = main_maccore_ethphy_liteethphygmiimiirx_converter_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_valid = main_maccore_ethphy_liteethphygmiimiirx_converter_sink_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_first = main_maccore_ethphy_liteethphygmiimiirx_converter_sink_first;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_last = main_maccore_ethphy_liteethphygmiimiirx_converter_sink_last;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_sink_ready = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_payload_data = {main_maccore_ethphy_liteethphygmiimiirx_converter_sink_payload_data};
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_valid = main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_first = main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_first;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_last = main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_last;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_ready = main_maccore_ethphy_liteethphygmiimiirx_converter_source_ready;
always @(*) begin
	main_maccore_ethphy_liteethphygmiimiirx_converter_source_payload_data <= 8'd0;
	main_maccore_ethphy_liteethphygmiimiirx_converter_source_payload_data[3:0] <= main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_payload_data[3:0];
	main_maccore_ethphy_liteethphygmiimiirx_converter_source_payload_data[7:4] <= main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_payload_data[7:4];
end
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_valid = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_valid;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_ready = main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_ready;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_first = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_last = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_source_source_payload_data = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready = ((~main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all) | main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_ready);
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_valid = main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all;
assign main_maccore_ethphy_liteethphygmiimiirx_converter_converter_load_part = (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_valid & main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready);
always @(*) begin
	main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_ready <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_valid <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_first <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_last <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_data <= 8'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_last_be <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_error <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_ready <= 1'd0;
	case (main_maccore_ethphy_liteethphygmiimiirx_mux_sel)
		1'd0: begin
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_valid <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_valid;
			main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_ready <= main_maccore_ethphy_liteethphygmiimiirx_mux_source_ready;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_first <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_first;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_last <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_last;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_data <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_data;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_last_be <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_last_be;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_error <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint0_sink_payload_error;
		end
		1'd1: begin
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_valid <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_valid;
			main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_ready <= main_maccore_ethphy_liteethphygmiimiirx_mux_source_ready;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_first <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_first;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_last <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_last;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_data <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_data;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_last_be <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_last_be;
			main_maccore_ethphy_liteethphygmiimiirx_mux_source_payload_error <= main_maccore_ethphy_liteethphygmiimiirx_mux_endpoint1_sink_payload_error;
		end
	endcase
end
assign gmii_eth_mdc = main_maccore_ethphy__w_storage[0];
...
assign main_liteethmaccrc32inserter_sink_valid = main_bufferizeendpoints_source_valid;
assign main_bufferizeendpoints_source_ready = main_liteethmaccrc32inserter_sink_ready;
assign main_liteethmaccrc32inserter_sink_first = main_bufferizeendpoints_source_first;
assign main_liteethmaccrc32inserter_sink_last = main_bufferizeendpoints_source_last;
assign main_liteethmaccrc32inserter_sink_payload_data = main_bufferizeendpoints_source_payload_data;
assign main_liteethmaccrc32inserter_sink_payload_last_be = main_bufferizeendpoints_source_payload_last_be;
assign main_liteethmaccrc32inserter_sink_payload_error = main_bufferizeendpoints_source_payload_error;
always @(*) begin
	main_liteethmaccrc32inserter_last_be1 <= 1'd0;
	if ((main_liteethmaccrc32inserter_last_be0 != 1'd0)) begin
		main_liteethmaccrc32inserter_last_be1 <= main_liteethmaccrc32inserter_last_be0;
	end else begin
		main_liteethmaccrc32inserter_last_be1 <= 1'd1;
	end
end
assign main_liteethmaccrc32inserter_data1 = main_liteethmaccrc32inserter_data0[7:0];
assign main_liteethmaccrc32inserter_last = main_liteethmaccrc32inserter_reg;
always @(*) begin
	main_liteethmaccrc32inserter_value <= 32'd0;
	main_liteethmaccrc32inserter_error <= 1'd0;
	if (main_liteethmaccrc32inserter_last_be1) begin
		main_liteethmaccrc32inserter_value <= {builder_t_slice_proxy31[0], builder_t_slice_proxy30[1], builder_t_slice_proxy29[2], builder_t_slice_proxy28[3], builder_t_slice_proxy27[4], builder_t_slice_proxy26[5], builder_t_slice_proxy25[6], builder_t_slice_proxy24[7], builder_t_slice_proxy23[8], builder_t_slice_proxy22[9], builder_t_slice_proxy21[10], builder_t_slice_proxy20[11], builder_t_slice_proxy19[12], builder_t_slice_proxy18[13], builder_t_slice_proxy17[14], builder_t_slice_proxy16[15], builder_t_slice_proxy15[16], builder_t_slice_proxy14[17], builder_t_slice_proxy13[18], builder_t_slice_proxy12[19], builder_t_slice_proxy11[20], builder_t_slice_proxy10[21], builder_t_slice_proxy9[22], builder_t_slice_proxy8[23], builder_t_slice_proxy7[24], builder_t_slice_proxy6[25], builder_t_slice_proxy5[26], builder_t_slice_proxy4[27], builder_t_slice_proxy3[28], builder_t_slice_proxy2[29], builder_t_slice_proxy1[30], builder_t_slice_proxy0[31]};
		main_liteethmaccrc32inserter_error <= (main_liteethmaccrc32inserter_next != 32'd3338984827);
	end
end
always @(*) begin
...
always @(*) begin
	...
	main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value0 <= 32'd0;
	main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value_ce0 <= 1'd0;
	...
	case (builder_maccore_txdatapath_bufferizeendpoints_state)
		1'd1: begin
			...
			main_liteethmaccrc32inserter_last_be0 <= main_liteethmaccrc32inserter_sink_payload_last_be;
			...
			main_liteethmaccrc32inserter_source_last <= 1'd0;
			main_liteethmaccrc32inserter_source_payload_last_be <= 1'd0;
			if (main_liteethmaccrc32inserter_sink_last) begin
				if (main_liteethmaccrc32inserter_sink_payload_last_be) begin
					main_liteethmaccrc32inserter_source_payload_data <= builder_cases_slice_proxy[7:0];
				end
				if ((1'd0 & (main_liteethmaccrc32inserter_sink_payload_last_be <= 4'd15))) begin
					main_liteethmaccrc32inserter_source_last <= 1'd1;
					main_liteethmaccrc32inserter_source_payload_last_be <= (main_liteethmaccrc32inserter_sink_payload_last_be <<< -3'd3);
				end
			end else begin
				main_liteethmaccrc32inserter_ce <= (main_liteethmaccrc32inserter_sink_valid & main_liteethmaccrc32inserter_source_ready);
			end
			if (((main_liteethmaccrc32inserter_sink_valid & main_liteethmaccrc32inserter_sink_last) & main_liteethmaccrc32inserter_source_ready)) begin
				if ((1'd0 & (main_liteethmaccrc32inserter_sink_payload_last_be <= 4'd15))) begin
					...
					main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value0 <= main_liteethmaccrc32inserter_value;
					main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value_ce0 <= 1'd1;
					if (1'd0) begin
						main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value1 <= (main_liteethmaccrc32inserter_sink_payload_last_be >>> 3'd4);
						main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value_ce1 <= 1'd1;
					end else begin
						main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value1 <= main_liteethmaccrc32inserter_sink_payload_last_be;
						main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value_ce1 <= 1'd1;
					end
		...
		2'd2: begin
			...
			case (main_liteethmaccrc32inserter_cnt)
				1'd0: begin
					main_liteethmaccrc32inserter_source_payload_data <= main_liteethmaccrc32inserter_crc_packet[31:24];
				end
				1'd1: begin
					main_liteethmaccrc32inserter_source_payload_data <= main_liteethmaccrc32inserter_crc_packet[23:16];
				end
				2'd2: begin
					main_liteethmaccrc32inserter_source_payload_data <= main_liteethmaccrc32inserter_crc_packet[15:8];
				end
				default: begin
					main_liteethmaccrc32inserter_source_payload_data <= main_liteethmaccrc32inserter_crc_packet[7:0];
				end
			endcase
...
assign main_bufferizeendpoints_sink_valid = main_tx_padding_source_valid;
assign main_tx_padding_source_ready = main_bufferizeendpoints_sink_ready;
assign main_bufferizeendpoints_sink_first = main_tx_padding_source_first;
assign main_bufferizeendpoints_sink_last = main_tx_padding_source_last;
assign main_bufferizeendpoints_sink_payload_data = main_tx_padding_source_payload_data;
assign main_bufferizeendpoints_sink_payload_last_be = main_tx_padding_source_payload_last_be;
assign main_bufferizeendpoints_sink_payload_error = main_tx_padding_source_payload_error;
assign main_tx_preamble_sink_valid = main_liteethmaccrc32inserter_source_valid;
assign main_liteethmaccrc32inserter_source_ready = main_tx_preamble_sink_ready;
assign main_tx_preamble_sink_first = main_liteethmaccrc32inserter_source_first;
assign main_tx_preamble_sink_last = main_liteethmaccrc32inserter_source_last;
assign main_tx_preamble_sink_payload_data = main_liteethmaccrc32inserter_source_payload_data;
assign main_tx_preamble_sink_payload_last_be = main_liteethmaccrc32inserter_source_payload_last_be;
assign main_tx_preamble_sink_payload_error = main_liteethmaccrc32inserter_source_payload_error;
...
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_valid0 = main_tx_gap_source_valid;
assign main_tx_gap_source_ready = main_maccore_ethphy_liteethphygmiimiitx_sink_sink_ready0;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_first0 = main_tx_gap_source_first;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_last0 = main_tx_gap_source_last;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_data0 = main_tx_gap_source_payload_data;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_last_be0 = main_tx_gap_source_payload_last_be;
assign main_maccore_ethphy_liteethphygmiimiitx_sink_sink_payload_error0 = main_tx_gap_source_payload_error;
assign main_pulsesynchronizer0_i = main_rx_preamble_error;
assign main_pulsesynchronizer1_i = main_rx_crc_error;
...
assign main_rx_crc_fifo_full = (main_rx_crc_syncfifo_level == 3'd4);
assign main_rx_crc_fifo_in = (main_rx_crc_sink_sink_valid & ((~main_rx_crc_fifo_full) | main_rx_crc_fifo_out));
assign main_rx_crc_fifo_out = (main_rx_crc_source_source_valid & main_rx_crc_source_source_ready);
assign main_rx_crc_syncfifo_sink_first = main_rx_crc_sink_sink_first;
assign main_rx_crc_syncfifo_sink_last = main_rx_crc_sink_sink_last;
assign main_rx_crc_syncfifo_sink_payload_data = main_rx_crc_sink_sink_payload_data;
assign main_rx_crc_syncfifo_sink_payload_last_be = main_rx_crc_sink_sink_payload_last_be;
assign main_rx_crc_syncfifo_sink_payload_error = main_rx_crc_sink_sink_payload_error;
always @(*) begin
	main_rx_crc_syncfifo_sink_valid <= 1'd0;
	main_rx_crc_syncfifo_sink_valid <= main_rx_crc_sink_sink_valid;
	main_rx_crc_syncfifo_sink_valid <= main_rx_crc_fifo_in;
end
always @(*) begin
	main_rx_crc_sink_sink_ready <= 1'd0;
	main_rx_crc_sink_sink_ready <= main_rx_crc_syncfifo_sink_ready;
	main_rx_crc_sink_sink_ready <= main_rx_crc_fifo_in;
end
assign main_rx_crc_crc_data0 = main_rx_crc_sink_sink_payload_data;
assign main_rx_crc_crc_last_be0 = main_rx_crc_sink_sink_payload_last_be;
assign main_rx_crc_sink_sink_valid = main_rx_crc_source_valid;
assign main_rx_crc_source_ready = main_rx_crc_sink_sink_ready;
assign main_rx_crc_sink_sink_first = main_rx_crc_source_first;
assign main_rx_crc_sink_sink_last = main_rx_crc_source_last;
assign main_rx_crc_sink_sink_payload_data = main_rx_crc_source_payload_data;
assign main_rx_crc_sink_sink_payload_last_be = main_rx_crc_source_payload_last_be;
assign main_rx_crc_sink_sink_payload_error = main_rx_crc_source_payload_error;
always @(*) begin
	main_rx_crc_crc_last_be1 <= 1'd0;
	if ((main_rx_crc_crc_last_be0 != 1'd0)) begin
		main_rx_crc_crc_last_be1 <= main_rx_crc_crc_last_be0;
	end else begin
		main_rx_crc_crc_last_be1 <= 1'd1;
	end
end
...
always @(*) begin
	main_rx_crc_crc_next <= 32'd0;
	main_rx_crc_crc_next[0] <= (((main_rx_crc_crc_last[24] ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[1] <= (((((((main_rx_crc_crc_last[25] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[2] <= (((((((((main_rx_crc_crc_last[26] ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[3] <= (((((((main_rx_crc_crc_last[27] ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[4] <= (((((((((main_rx_crc_crc_last[28] ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[5] <= (((((((((((((main_rx_crc_crc_last[29] ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[6] <= (((((((((((main_rx_crc_crc_last[30] ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[7] <= (((((((((main_rx_crc_crc_last[31] ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[8] <= ((((((((main_rx_crc_crc_last[0] ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[9] <= ((((((((main_rx_crc_crc_last[1] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[10] <= ((((((((main_rx_crc_crc_last[2] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[11] <= ((((((((main_rx_crc_crc_last[3] ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[12] <= ((((((((((((main_rx_crc_crc_last[4] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[13] <= ((((((((((((main_rx_crc_crc_last[5] ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[14] <= ((((((((((main_rx_crc_crc_last[6] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]);
	main_rx_crc_crc_next[15] <= ((((((((main_rx_crc_crc_last[7] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]);
	main_rx_crc_crc_next[16] <= ((((((main_rx_crc_crc_last[8] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[17] <= ((((((main_rx_crc_crc_last[9] ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[18] <= ((((((main_rx_crc_crc_last[10] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]);
	main_rx_crc_crc_next[19] <= ((((main_rx_crc_crc_last[11] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]);
	main_rx_crc_crc_next[20] <= ((main_rx_crc_crc_last[12] ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]);
	main_rx_crc_crc_next[21] <= ((main_rx_crc_crc_last[13] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]);
	main_rx_crc_crc_next[22] <= ((main_rx_crc_crc_last[14] ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[23] <= ((((((main_rx_crc_crc_last[15] ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_data1[6]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[24] <= ((((((main_rx_crc_crc_last[16] ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[25] <= ((((main_rx_crc_crc_last[17] ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]);
	main_rx_crc_crc_next[26] <= ((((((((main_rx_crc_crc_last[18] ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]) ^ main_rx_crc_crc_last[24]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_data1[7]);
	main_rx_crc_crc_next[27] <= ((((((((main_rx_crc_crc_last[19] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]) ^ main_rx_crc_crc_last[25]) ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_data1[6]);
	main_rx_crc_crc_next[28] <= ((((((main_rx_crc_crc_last[20] ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]) ^ main_rx_crc_crc_last[26]) ^ main_rx_crc_crc_data1[5]);
	main_rx_crc_crc_next[29] <= ((((((main_rx_crc_crc_last[21] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[30]) ^ main_rx_crc_crc_data1[1]) ^ main_rx_crc_crc_last[27]) ^ main_rx_crc_crc_data1[4]);
	main_rx_crc_crc_next[30] <= ((((main_rx_crc_crc_last[22] ^ main_rx_crc_crc_last[31]) ^ main_rx_crc_crc_data1[0]) ^ main_rx_crc_crc_last[28]) ^ main_rx_crc_crc_data1[3]);
	main_rx_crc_crc_next[31] <= ((main_rx_crc_crc_last[23] ^ main_rx_crc_crc_last[29]) ^ main_rx_crc_crc_data1[2]);
end
assign main_rx_crc_syncfifo_syncfifo_din = {main_rx_crc_syncfifo_fifo_in_last, main_rx_crc_syncfifo_fifo_in_first, main_rx_crc_syncfifo_fifo_in_payload_error, main_rx_crc_syncfifo_fifo_in_payload_last_be, main_rx_crc_syncfifo_fifo_in_payload_data};
assign {main_rx_crc_syncfifo_fifo_out_last, main_rx_crc_syncfifo_fifo_out_first, main_rx_crc_syncfifo_fifo_out_payload_error, main_rx_crc_syncfifo_fifo_out_payload_last_be, main_rx_crc_syncfifo_fifo_out_payload_data} = main_rx_crc_syncfifo_syncfifo_dout;
assign main_rx_crc_syncfifo_sink_ready = main_rx_crc_syncfifo_syncfifo_writable;
assign main_rx_crc_syncfifo_syncfifo_we = main_rx_crc_syncfifo_sink_valid;
assign main_rx_crc_syncfifo_fifo_in_first = main_rx_crc_syncfifo_sink_first;
assign main_rx_crc_syncfifo_fifo_in_last = main_rx_crc_syncfifo_sink_last;
assign main_rx_crc_syncfifo_fifo_in_payload_data = main_rx_crc_syncfifo_sink_payload_data;
assign main_rx_crc_syncfifo_fifo_in_payload_last_be = main_rx_crc_syncfifo_sink_payload_last_be;
assign main_rx_crc_syncfifo_fifo_in_payload_error = main_rx_crc_syncfifo_sink_payload_error;
assign main_rx_crc_syncfifo_source_valid = main_rx_crc_syncfifo_syncfifo_readable;
assign main_rx_crc_syncfifo_source_first = main_rx_crc_syncfifo_fifo_out_first;
assign main_rx_crc_syncfifo_source_last = main_rx_crc_syncfifo_fifo_out_last;
assign main_rx_crc_syncfifo_source_payload_data = main_rx_crc_syncfifo_fifo_out_payload_data;
assign main_rx_crc_syncfifo_source_payload_last_be = main_rx_crc_syncfifo_fifo_out_payload_last_be;
assign main_rx_crc_syncfifo_source_payload_error = main_rx_crc_syncfifo_fifo_out_payload_error;
assign main_rx_crc_syncfifo_syncfifo_re = main_rx_crc_syncfifo_source_ready;
always @(*) begin
	main_rx_crc_syncfifo_wrport_adr <= 3'd0;
	if (main_rx_crc_syncfifo_replace) begin
		main_rx_crc_syncfifo_wrport_adr <= (main_rx_crc_syncfifo_produce - 1'd1);
	end else begin
		main_rx_crc_syncfifo_wrport_adr <= main_rx_crc_syncfifo_produce;
	end
end
assign main_rx_crc_syncfifo_wrport_dat_w = main_rx_crc_syncfifo_syncfifo_din;
assign main_rx_crc_syncfifo_wrport_we = (main_rx_crc_syncfifo_syncfifo_we & (main_rx_crc_syncfifo_syncfifo_writable | main_rx_crc_syncfifo_replace));
assign main_rx_crc_syncfifo_do_read = (main_rx_crc_syncfifo_syncfifo_readable & main_rx_crc_syncfifo_syncfifo_re);
assign main_rx_crc_syncfifo_rdport_adr = main_rx_crc_syncfifo_consume;
assign main_rx_crc_syncfifo_syncfifo_dout = main_rx_crc_syncfifo_rdport_dat_r;
...
always @(*) begin
	...
	main_rx_crc_source_source_first <= 1'd0;
	main_rx_crc_crc_reset <= 1'd0;
	main_rx_crc_source_source_last <= 1'd0;
	main_rx_crc_source_source_payload_data <= 8'd0;
	builder_maccore_rxdatapath_bufferizeendpoints_next_state <= 2'd0;
	main_rx_crc_source_source_payload_last_be <= 1'd0;
	main_rx_crc_source_source_payload_error <= 1'd0;
	...
	case (builder_maccore_rxdatapath_bufferizeendpoints_state)
		1'd1: begin
			if ((main_rx_crc_sink_sink_valid & main_rx_crc_sink_sink_ready)) begin
				main_rx_crc_crc_ce <= 1'd1;
				builder_maccore_rxdatapath_bufferizeendpoints_next_state <= 2'd2;
			end
		end
		2'd2: begin
			main_rx_crc_syncfifo_source_ready <= main_rx_crc_fifo_out;
			main_rx_crc_source_source_valid <= (main_rx_crc_sink_sink_valid & main_rx_crc_fifo_full);
			main_rx_crc_source_source_payload_data <= main_rx_crc_syncfifo_source_payload_data;
			main_rx_crc_source_source_payload_last_be <= main_rx_crc_syncfifo_source_payload_last_be;
			main_rx_crc_source_source_payload_error <= main_rx_crc_syncfifo_source_payload_error;
			if (1'd1) begin
				main_rx_crc_source_source_last <= main_rx_crc_sink_sink_last;
				main_rx_crc_source_source_payload_last_be <= main_rx_crc_sink_sink_payload_last_be;
			end else begin
				if ((main_rx_crc_sink_sink_payload_last_be & 4'd15)) begin
					main_rx_crc_source_source_last <= main_rx_crc_sink_sink_last;
					main_rx_crc_source_source_payload_last_be <= (main_rx_crc_sink_sink_payload_last_be <<< -3'd3);
				end else begin
					main_rx_crc_last_be_next_value0 <= (main_rx_crc_sink_sink_payload_last_be >>> 3'd4);
					main_rx_crc_last_be_next_value_ce0 <= 1'd1;
					main_rx_crc_crc_error1_next_value1 <= main_rx_crc_crc_error0;
					main_rx_crc_crc_error1_next_value_ce1 <= 1'd1;
				end
			end
			main_rx_crc_source_source_payload_error <= (main_rx_crc_sink_sink_payload_error | {1{(main_rx_crc_crc_error0 & main_rx_crc_sink_sink_last)}});
			main_rx_crc_error <= ((main_rx_crc_sink_sink_valid & main_rx_crc_sink_sink_last) & main_rx_crc_crc_error0);
			if ((main_rx_crc_sink_sink_valid & main_rx_crc_sink_sink_ready)) begin
				main_rx_crc_crc_ce <= 1'd1;
				if ((main_rx_crc_sink_sink_last & (main_rx_crc_sink_sink_payload_last_be > 4'd15))) begin
					builder_maccore_rxdatapath_bufferizeendpoints_next_state <= 2'd3;
				end else begin
					if (main_rx_crc_sink_sink_last) begin
		...
		2'd3: begin
			main_rx_crc_source_source_valid <= main_rx_crc_syncfifo_source_valid;
			main_rx_crc_syncfifo_source_ready <= main_rx_crc_source_source_ready;
			main_rx_crc_source_source_first <= main_rx_crc_syncfifo_source_first;
			main_rx_crc_source_source_last <= main_rx_crc_syncfifo_source_last;
			main_rx_crc_source_source_payload_data <= main_rx_crc_syncfifo_source_payload_data;
			main_rx_crc_source_source_payload_last_be <= main_rx_crc_syncfifo_source_payload_last_be;
			main_rx_crc_source_source_payload_error <= main_rx_crc_syncfifo_source_payload_error;
			main_rx_crc_source_source_payload_error <= (main_rx_crc_syncfifo_source_payload_error | {1{main_rx_crc_crc_error1}});
			main_rx_crc_source_source_payload_last_be <= main_rx_crc_last_be;
			if ((main_rx_crc_source_source_valid & main_rx_crc_source_source_ready)) begin
				builder_maccore_rxdatapath_bufferizeendpoints_next_state <= 1'd0;
			end
		end
		default: begin
			main_rx_crc_crc_reset <= 1'd1;
			main_rx_crc_fifo_reset <= 1'd1;
			builder_maccore_rxdatapath_bufferizeendpoints_next_state <= 1'd1;
		end
	endcase
end
assign main_rx_crc_sink_ready = ((~main_rx_crc_source_valid) | main_rx_crc_source_ready);
...
assign main_rx_preamble_sink_valid = main_maccore_ethphy_liteethphygmiimiirx_source_source_valid0;
assign main_maccore_ethphy_liteethphygmiimiirx_source_source_ready0 = main_rx_preamble_sink_ready;
assign main_rx_preamble_sink_first = main_maccore_ethphy_liteethphygmiimiirx_source_source_first0;
assign main_rx_preamble_sink_last = main_maccore_ethphy_liteethphygmiimiirx_source_source_last0;
assign main_rx_preamble_sink_payload_data = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_data0;
assign main_rx_preamble_sink_payload_last_be = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_last_be0;
assign main_rx_preamble_sink_payload_error = main_maccore_ethphy_liteethphygmiimiirx_source_source_payload_error0;
assign main_rx_crc_sink_valid = main_rx_preamble_source_valid;
assign main_rx_preamble_source_ready = main_rx_crc_sink_ready;
assign main_rx_crc_sink_first = main_rx_preamble_source_first;
assign main_rx_crc_sink_last = main_rx_preamble_source_last;
assign main_rx_crc_sink_payload_data = main_rx_preamble_source_payload_data;
assign main_rx_crc_sink_payload_last_be = main_rx_preamble_source_payload_last_be;
assign main_rx_crc_sink_payload_error = main_rx_preamble_source_payload_error;
assign main_rx_padding_sink_valid = main_rx_crc_source_source_valid;
assign main_rx_crc_source_source_ready = main_rx_padding_sink_ready;
assign main_rx_padding_sink_first = main_rx_crc_source_source_first;
assign main_rx_padding_sink_last = main_rx_crc_source_source_last;
assign main_rx_padding_sink_payload_data = main_rx_crc_source_source_payload_data;
assign main_rx_padding_sink_payload_last_be = main_rx_crc_source_source_payload_last_be;
assign main_rx_padding_sink_payload_error = main_rx_crc_source_source_payload_error;
...
always @(*) begin
	...
	builder_maccore_wishbone2csr_next_state <= 1'd0;
	builder_maccore_we <= 1'd0;
	builder_maccore_wishbone_ack <= 1'd0;
	builder_maccore_wishbone2csr_next_state <= builder_maccore_wishbone2csr_state;
	case (builder_maccore_wishbone2csr_state)
		1'd1: begin
		...
		default: begin
			...
			if ((builder_maccore_wishbone_cyc & builder_maccore_wishbone_stb)) begin
				...
				builder_maccore_wishbone2csr_next_state <= 1'd1;
			end
		end
	endcase
end
...
assign builder_csrbank2_mode_detection_mode_r = builder_interface2_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank2_mode_detection_mode_we <= 1'd0;
	builder_csrbank2_mode_detection_mode_re <= 1'd0;
	if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank2_mode_detection_mode_re <= builder_interface2_bank_bus_we;
		builder_csrbank2_mode_detection_mode_we <= (~builder_interface2_bank_bus_we);
	end
end
...
assign builder_csrbank2_mode_detection_mode_w = main_maccore_ethphy_mode_status;
assign main_maccore_ethphy_mode_we = builder_csrbank2_mode_detection_mode_we;
...
assign builder_t_slice_proxy0 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy1 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy2 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy3 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy4 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy5 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy6 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy7 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy8 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy9 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy10 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy11 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy12 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy13 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy14 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy15 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy16 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy17 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy18 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy19 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy20 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy21 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy22 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy23 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy24 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy25 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy26 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy27 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy28 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy29 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy30 = (~main_liteethmaccrc32inserter_next);
assign builder_t_slice_proxy31 = (~main_liteethmaccrc32inserter_next);
assign builder_cases_slice_proxy = {main_liteethmaccrc32inserter_value, main_liteethmaccrc32inserter_sink_payload_data[7:0]};
assign builder_t_slice_proxy32 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy33 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy34 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy35 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy36 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy37 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy38 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy39 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy40 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy41 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy42 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy43 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy44 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy45 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy46 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy47 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy48 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy49 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy50 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy51 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy52 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy53 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy54 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy55 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy56 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy57 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy58 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy59 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy60 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy61 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy62 = (~main_rx_crc_crc_next);
assign builder_t_slice_proxy63 = (~main_rx_crc_crc_next);
always @(*) begin
...
assign main_maccore_ethphy_toggle_o = builder_xilinxmultiregimpl0_regs1;
always @(*) begin
	main_maccore_ethphy__r_status <= 1'd0;
	main_maccore_ethphy__r_status <= main_maccore_ethphy_r;
	main_maccore_ethphy__r_status <= builder_xilinxmultiregimpl1_regs1;
end
assign main_tx_cdc_cdc_produce_rdomain = builder_xilinxmultiregimpl2_regs1;
assign main_tx_cdc_cdc_consume_wdomain = builder_xilinxmultiregimpl3_regs1;
assign main_pulsesynchronizer0_toggle_o = builder_xilinxmultiregimpl4_regs1;
assign main_pulsesynchronizer1_toggle_o = builder_xilinxmultiregimpl5_regs1;
assign main_rx_cdc_cdc_produce_rdomain = builder_xilinxmultiregimpl6_regs1;
assign main_rx_cdc_cdc_consume_wdomain = builder_xilinxmultiregimpl7_regs1;
...
always @(posedge eth_rx_clk) begin
	main_maccore_ethphy_eth_counter <= (main_maccore_ethphy_eth_counter + 1'd1);
	if (main_maccore_ethphy_i) begin
		main_maccore_ethphy_toggle_i <= (~main_maccore_ethphy_toggle_i);
	end
	main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv <= gmii_eth_rx_dv;
	main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_data <= gmii_eth_rx_data;
	main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_dv_d <= main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv;
	main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_valid <= main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv;
	main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_data <= main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_data;
	main_maccore_ethphy_liteethphygmiimiirx_converter_reset <= (~main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_dv);
	main_maccore_ethphy_liteethphygmiimiirx_converter_sink_valid <= 1'd1;
	main_maccore_ethphy_liteethphygmiimiirx_converter_sink_payload_data <= main_maccore_ethphy_liteethphygmiimiirx_pads_d_rx_data;
	if (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_ready) begin
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all <= 1'd0;
	end
	if (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_load_part) begin
		if (((main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux == 1'd1) | main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_last)) begin
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux <= 1'd0;
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all <= 1'd1;
		end else begin
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux <= (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux + 1'd1);
		end
	end
	if ((main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_valid & main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_ready)) begin
		if ((main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_valid & main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready)) begin
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first <= main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_first;
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last <= main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_last;
		end else begin
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first <= 1'd0;
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last <= 1'd0;
		end
	end else begin
		if ((main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_valid & main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_ready)) begin
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first <= (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_first | main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_first);
			main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last <= (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_last | main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_last);
		end
	end
	if (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_load_part) begin
		case (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux)
			1'd0: begin
				main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data[3:0] <= main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_payload_data;
			end
			1'd1: begin
				main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data[7:4] <= main_maccore_ethphy_liteethphygmiimiirx_converter_converter_sink_payload_data;
			end
		endcase
	end
	if (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_load_part) begin
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_valid_token_count <= (main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux + 1'd1);
	end
	if (main_maccore_ethphy_liteethphygmiimiirx_converter_reset) begin
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data <= 8'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_valid_token_count <= 2'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all <= 1'd0;
	end
	...
	if (main_rx_crc_crc_ce) begin
		main_rx_crc_crc_reg <= main_rx_crc_crc_next;
	end
	if (main_rx_crc_crc_reset) begin
		main_rx_crc_crc_reg <= 32'd4294967295;
	end
	if (((main_rx_crc_syncfifo_syncfifo_we & main_rx_crc_syncfifo_syncfifo_writable) & (~main_rx_crc_syncfifo_replace))) begin
		if ((main_rx_crc_syncfifo_produce == 3'd4)) begin
			main_rx_crc_syncfifo_produce <= 1'd0;
		end else begin
			main_rx_crc_syncfifo_produce <= (main_rx_crc_syncfifo_produce + 1'd1);
		end
	end
	if (main_rx_crc_syncfifo_do_read) begin
		if ((main_rx_crc_syncfifo_consume == 3'd4)) begin
			main_rx_crc_syncfifo_consume <= 1'd0;
		end else begin
			main_rx_crc_syncfifo_consume <= (main_rx_crc_syncfifo_consume + 1'd1);
		end
	end
	if (((main_rx_crc_syncfifo_syncfifo_we & main_rx_crc_syncfifo_syncfifo_writable) & (~main_rx_crc_syncfifo_replace))) begin
		if ((~main_rx_crc_syncfifo_do_read)) begin
			main_rx_crc_syncfifo_level <= (main_rx_crc_syncfifo_level + 1'd1);
		end
	end else begin
		if (main_rx_crc_syncfifo_do_read) begin
			main_rx_crc_syncfifo_level <= (main_rx_crc_syncfifo_level - 1'd1);
	...
	if (main_rx_crc_fifo_reset) begin
		main_rx_crc_syncfifo_level <= 3'd0;
		main_rx_crc_syncfifo_produce <= 3'd0;
		main_rx_crc_syncfifo_consume <= 3'd0;
	end
	builder_maccore_rxdatapath_bufferizeendpoints_state <= builder_maccore_rxdatapath_bufferizeendpoints_next_state;
	if (main_rx_crc_last_be_next_value_ce0) begin
		main_rx_crc_last_be <= main_rx_crc_last_be_next_value0;
	end
	if (main_rx_crc_crc_error1_next_value_ce1) begin
		main_rx_crc_crc_error1 <= main_rx_crc_crc_error1_next_value1;
	end
	if (((~main_rx_crc_source_valid) | main_rx_crc_source_ready)) begin
		main_rx_crc_source_valid <= main_rx_crc_sink_valid;
		main_rx_crc_source_first <= main_rx_crc_sink_first;
		main_rx_crc_source_last <= main_rx_crc_sink_last;
		main_rx_crc_source_payload_data <= main_rx_crc_sink_payload_data;
		main_rx_crc_source_payload_last_be <= main_rx_crc_sink_payload_last_be;
		main_rx_crc_source_payload_error <= main_rx_crc_sink_payload_error;
	end
	...
	if (eth_rx_rst) begin
		main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_valid <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_source_payload_data <= 8'd0;
		main_maccore_ethphy_liteethphygmiimiirx_gmii_rx_dv_d <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_sink_valid <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_sink_payload_data <= 4'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_data <= 8'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_source_payload_valid_token_count <= 2'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_demux <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_converter_strobe_all <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiirx_converter_reset <= 1'd0;
		main_rx_crc_crc_reg <= 32'd4294967295;
		main_rx_crc_syncfifo_level <= 3'd0;
		main_rx_crc_syncfifo_produce <= 3'd0;
		main_rx_crc_syncfifo_consume <= 3'd0;
		main_rx_crc_last_be <= 1'd0;
		main_rx_crc_crc_error1 <= 1'd0;
		main_rx_crc_source_valid <= 1'd0;
		main_rx_crc_source_payload_data <= 8'd0;
		main_rx_crc_source_payload_last_be <= 1'd0;
		main_rx_crc_source_payload_error <= 1'd0;
	...
	builder_xilinxmultiregimpl7_regs0 <= main_rx_cdc_cdc_graycounter1_q;
	builder_xilinxmultiregimpl7_regs1 <= builder_xilinxmultiregimpl7_regs0;
end

always @(posedge eth_tx_clk) begin
	if ((main_maccore_ethphy_mode0 == 1'd1)) begin
		gmii_eth_tx_en <= main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_en;
		gmii_eth_tx_data <= main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_data;
	end else begin
		gmii_eth_tx_en <= main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_en;
		gmii_eth_tx_data <= main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_data;
	end
	main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_er <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_en <= main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_valid;
	main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_pads_tx_data <= main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_payload_data;
	main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_ready <= 1'd1;
	main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_er <= 1'd0;
	main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_en <= main_maccore_ethphy_liteethphygmiimiitx_converter_source_valid;
	main_maccore_ethphy_liteethphygmiimiitx_mii_tx_pads_tx_data <= main_maccore_ethphy_liteethphygmiimiitx_converter_source_payload_data;
	if ((main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_valid & main_maccore_ethphy_liteethphygmiimiitx_converter_converter_source_ready)) begin
		if (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_last) begin
			main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux <= 1'd0;
		end else begin
			main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux <= (main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux + 1'd1);
		end
	end
	...
	if (main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value_ce0) begin
		main_liteethmaccrc32inserter_crc_packet <= main_liteethmaccrc32inserter_crc_packet_clockdomainsrenamer1_next_value0;
	end
	if (main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value_ce1) begin
		main_liteethmaccrc32inserter_last_be2 <= main_liteethmaccrc32inserter_last_be2_clockdomainsrenamer1_next_value1;
	end
	if (((~main_bufferizeendpoints_source_valid) | main_bufferizeendpoints_source_ready)) begin
		main_bufferizeendpoints_source_valid <= main_bufferizeendpoints_sink_valid;
		main_bufferizeendpoints_source_first <= main_bufferizeendpoints_sink_first;
		main_bufferizeendpoints_source_last <= main_bufferizeendpoints_sink_last;
		main_bufferizeendpoints_source_payload_data <= main_bufferizeendpoints_sink_payload_data;
		main_bufferizeendpoints_source_payload_last_be <= main_bufferizeendpoints_sink_payload_last_be;
		main_bufferizeendpoints_source_payload_error <= main_bufferizeendpoints_sink_payload_error;
	end
	...
	if (eth_tx_rst) begin
		main_maccore_ethphy_liteethphygmiimiitx_gmii_tx_sink_ready <= 1'd0;
		main_maccore_ethphy_liteethphygmiimiitx_converter_converter_mux <= 1'd0;
		...
		main_liteethmaccrc32inserter_reg <= 32'd4294967295;
		main_liteethmaccrc32inserter_crc_packet <= 32'd0;
		main_liteethmaccrc32inserter_last_be2 <= 1'd0;
		main_liteethmaccrc32inserter_cnt <= 2'd3;
		main_bufferizeendpoints_source_valid <= 1'd0;
		main_bufferizeendpoints_source_payload_data <= 8'd0;
		main_bufferizeendpoints_source_payload_last_be <= 1'd0;
		main_bufferizeendpoints_source_payload_error <= 1'd0;
	...
	builder_xilinxmultiregimpl2_regs0 <= main_tx_cdc_cdc_graycounter0_q;
...
always @(posedge sys_clk) begin
	...
	if (main_maccore_ethphy_update_mode) begin
		main_maccore_ethphy_mode0 <= main_maccore_ethphy_mode1;
	end
	if (main_maccore_ethphy_sys_counter_reset) begin
		main_maccore_ethphy_sys_counter <= 1'd0;
	end else begin
		if (main_maccore_ethphy_sys_counter_ce) begin
			main_maccore_ethphy_sys_counter <= (main_maccore_ethphy_sys_counter + 1'd1);
		end
	end
	main_maccore_ethphy_toggle_o_r <= main_maccore_ethphy_toggle_o;
	builder_maccore_liteethphygmiimii_state <= builder_maccore_liteethphygmiimii_next_state;
	...
	builder_maccore_wishbone2csr_state <= builder_maccore_wishbone2csr_next_state;
	...
	if (builder_csrbank2_sel) begin
		case (builder_interface2_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface2_bank_bus_dat_r <= builder_csrbank2_mode_detection_mode_w;
			end
			1'd1: begin
	...
	main_maccore_ethphy_mode_re <= builder_csrbank2_mode_detection_mode_re;
	...
	if (sys_rst) begin
		...
		main_maccore_ethphy_mode0 <= 1'd0;
		main_maccore_ethphy_mode_re <= 1'd0;
		...
		builder_count <= 20'd1000000;
		builder_maccore_liteethphygmiimii_state <= 2'd0;
		builder_maccore_liteethmacsramwriter_state <= 2'd0;
		builder_maccore_liteethmacsramreader_state <= 2'd0;
		builder_maccore_wishbone2csr_state <= 1'd0;
	end
	builder_xilinxmultiregimpl0_regs0 <= main_maccore_ethphy_toggle_i;
	builder_xilinxmultiregimpl0_regs1 <= builder_xilinxmultiregimpl0_regs0;
	builder_xilinxmultiregimpl1_regs0 <= main_maccore_ethphy_data_r;
	builder_xilinxmultiregimpl1_regs1 <= builder_xilinxmultiregimpl1_regs0;
	builder_xilinxmultiregimpl3_regs0 <= main_tx_cdc_cdc_graycounter1_q;
	builder_xilinxmultiregimpl3_regs1 <= builder_xilinxmultiregimpl3_regs0;
	builder_xilinxmultiregimpl4_regs0 <= main_pulsesynchronizer0_toggle_i;
	builder_xilinxmultiregimpl4_regs1 <= builder_xilinxmultiregimpl4_regs0;
	builder_xilinxmultiregimpl5_regs0 <= main_pulsesynchronizer1_toggle_i;
	builder_xilinxmultiregimpl5_regs1 <= builder_xilinxmultiregimpl5_regs0;
	builder_xilinxmultiregimpl6_regs0 <= main_rx_cdc_cdc_graycounter0_q;
...
BUFG BUFG_1(
	.I(main_maccore_ethphy_eth_tx_clk),
	.O(eth_tx_clk)
);

assign gmii_eth_mdio = main_maccore_ethphy_data_oe ? main_maccore_ethphy_data_w : 1'bz;
assign main_maccore_ethphy_data_r = gmii_eth_mdio;
...
always @(posedge eth_rx_clk) begin
	if (main_rx_crc_syncfifo_wrport_we)
		storage_1[main_rx_crc_syncfifo_wrport_adr] <= main_rx_crc_syncfifo_wrport_dat_w;
	storage_1_dat0 <= storage_1[main_rx_crc_syncfifo_wrport_adr];
end
always @(posedge eth_rx_clk) begin
end
assign main_rx_crc_syncfifo_wrport_dat_r = storage_1_dat0;
assign main_rx_crc_syncfifo_rdport_dat_r = storage_1[main_rx_crc_syncfifo_rdport_adr];
...
ODDR #(
	...
	.CE(1'd1),
	.D1(1'd1),
	.D2((main_maccore_ethphy_mode0 == 1'd1)),
	.R(1'd0),
	.S(1'd0),
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-08-04 21:03:50.
//------------------------------------------------------------------------------
