...
wire    [3:0] csrbank2_rx_inband_status_r;
reg           csrbank2_rx_inband_status_re = 1'd0;
wire    [3:0] csrbank2_rx_inband_status_w;
reg           csrbank2_rx_inband_status_we = 1'd0;
wire          csrbank2_sel;
wire   [31:0] dat_r;
wire   [31:0] dat_w;
wire          done;
...
reg     [1:0] maccore_ethphy_clock_speed = 2'd0;
wire          maccore_ethphy_data_oe;
wire          maccore_ethphy_data_r;
wire          maccore_ethphy_data_w;
reg           maccore_ethphy_duplex_status = 1'd0;
wire          maccore_ethphy_eth_tx_clk_o;
wire          maccore_ethphy_last;
reg           maccore_ethphy_link_status = 1'd0;
wire          maccore_ethphy_mdc;
wire          maccore_ethphy_oe;
reg           maccore_ethphy_r = 1'd0;
reg           maccore_ethphy_re = 1'd0;
wire          maccore_ethphy_reset;
reg           maccore_ethphy_reset_re = 1'd0;
reg           maccore_ethphy_reset_storage = 1'd0;
wire    [1:0] maccore_ethphy_rx_ctl;
wire          maccore_ethphy_rx_ctl_delayf;
reg     [1:0] maccore_ethphy_rx_ctl_reg = 2'd0;
reg     [1:0] maccore_ethphy_rx_ctl_reg_d = 2'd0;
wire    [7:0] maccore_ethphy_rx_data;
wire    [3:0] maccore_ethphy_rx_data_delayf;
reg     [7:0] maccore_ethphy_rx_data_reg = 8'd0;
...
reg     [3:0] maccore_ethphy_status = 4'd0;
wire          maccore_ethphy_tx_ctl_oddrx1f;
wire    [3:0] maccore_ethphy_tx_data_oddrx1f;
wire          maccore_ethphy_w;
wire          maccore_ethphy_we;
...
(* syn_no_retiming = "true" *)
reg     [5:0] multiregimpl60 = 6'd0;
(* syn_no_retiming = "true" *)
reg     [5:0] multiregimpl61 = 6'd0;
reg           next_state = 1'd0;
wire          por_clk;
wire          re;
wire          request;
...
assign maccore_ethphy_reset = maccore_ethphy_reset_storage;
assign rgmii_rst_n = (~maccore_ethphy_reset);
assign maccore_ethphy_sink_ready = 1'd1;
assign maccore_ethphy_last = ((~maccore_ethphy_rx_ctl_reg[0]) & maccore_ethphy_rx_ctl_reg_d[0]);
assign maccore_ethphy_source_last = maccore_ethphy_last;
...
assign csrbank2_rx_inband_status_r = interface2_bank_bus_dat_w[3:0];
always @(*) begin
    csrbank2_rx_inband_status_re <= 1'd0;
    csrbank2_rx_inband_status_we <= 1'd0;
    if ((csrbank2_sel & (interface2_bank_bus_adr[8:0] == 1'd1))) begin
        csrbank2_rx_inband_status_re <= interface2_bank_bus_we;
        csrbank2_rx_inband_status_we <= interface2_bank_bus_re;
    end
end
...
always @(*) begin
    maccore_ethphy_status <= 4'd0;
    maccore_ethphy_status[0] <= maccore_ethphy_link_status;
    maccore_ethphy_status[2:1] <= maccore_ethphy_clock_speed;
    maccore_ethphy_status[3] <= maccore_ethphy_duplex_status;
end
assign csrbank2_rx_inband_status_w = maccore_ethphy_status;
assign maccore_ethphy_we = csrbank2_rx_inband_status_we;
...
always @(*) begin
    ...
    maccore_ethphy__r_status <= multiregimpl01;
end
assign core_tx_cdc_cdc_produce_rdomain = multiregimpl11;
assign core_tx_cdc_cdc_consume_wdomain = multiregimpl21;
assign core_pulsesynchronizer0_toggle_o = multiregimpl31;
assign core_pulsesynchronizer1_toggle_o = multiregimpl41;
assign core_rx_cdc_cdc_produce_rdomain = multiregimpl51;
assign core_rx_cdc_cdc_consume_wdomain = multiregimpl61;
...
always @(posedge eth_rx_clk) begin
    maccore_ethphy_rx_ctl_reg <= maccore_ethphy_rx_ctl;
    maccore_ethphy_rx_data_reg <= maccore_ethphy_rx_data;
    maccore_ethphy_rx_ctl_reg_d <= maccore_ethphy_rx_ctl_reg;
    maccore_ethphy_source_valid <= maccore_ethphy_rx_ctl_reg[0];
    maccore_ethphy_source_payload_data <= maccore_ethphy_rx_data_reg;
    if ((maccore_ethphy_rx_ctl == 1'd0)) begin
        maccore_ethphy_link_status <= maccore_ethphy_rx_data[0];
        maccore_ethphy_clock_speed <= maccore_ethphy_rx_data[2:1];
        maccore_ethphy_duplex_status <= maccore_ethphy_rx_data[3];
    end
    ...
    if (eth_rx_rst) begin
        ...
        maccore_ethphy_link_status <= 1'd0;
        maccore_ethphy_clock_speed <= 2'd0;
        maccore_ethphy_duplex_status <= 1'd0;
        maccore_ethphy_rx_ctl_reg <= 2'd0;
        maccore_ethphy_rx_data_reg <= 8'd0;
        maccore_ethphy_rx_ctl_reg_d <= 2'd0;
        core_liteethmaccrc32checker_crc_reg <= 32'd4294967295;
        core_liteethmaccrc32checker_syncfifo_level <= 3'd0;
        core_liteethmaccrc32checker_syncfifo_produce <= 3'd0;
        core_liteethmaccrc32checker_syncfifo_consume <= 3'd0;
    ...
    multiregimpl60 <= core_rx_cdc_cdc_graycounter1_q;
...
always @(posedge eth_tx_clk) begin
    ...
    multiregimpl10 <= core_tx_cdc_cdc_graycounter0_q;
...
always @(posedge sys_clk) begin
    ...
    if (csrbank2_sel) begin
        case (interface2_bank_bus_adr[8:0])
            ...
            1'd1: begin
                interface2_bank_bus_dat_r <= csrbank2_rx_inband_status_w;
            end
            2'd2: begin
    ...
    maccore_ethphy_re <= csrbank2_rx_inband_status_re;
    ...
    multiregimpl00 <= maccore_ethphy_data_r;
    multiregimpl01 <= multiregimpl00;
    multiregimpl20 <= core_tx_cdc_cdc_graycounter1_q;
    multiregimpl21 <= multiregimpl20;
    multiregimpl30 <= core_pulsesynchronizer0_toggle_i;
    multiregimpl31 <= multiregimpl30;
    multiregimpl40 <= core_pulsesynchronizer1_toggle_i;
    multiregimpl41 <= multiregimpl40;
    multiregimpl50 <= core_rx_cdc_cdc_graycounter0_q;
...
DELAYG #(
	...
	// Inputs.
	.A (maccore_ethphy_tx_ctl_oddrx1f),
...
DELAYG #(
	...
	// Inputs.
	.A (maccore_ethphy_tx_data_oddrx1f[0]),
...
DELAYG #(
	...
	// Inputs.
	.A (maccore_ethphy_tx_data_oddrx1f[1]),
...
DELAYG #(
	...
	// Inputs.
	.A (maccore_ethphy_tx_data_oddrx1f[2]),
...
DELAYG #(
	...
	// Inputs.
	.A (maccore_ethphy_tx_data_oddrx1f[3]),
...
DELAYG #(
	...
	// Outputs.
	.Z (maccore_ethphy_rx_ctl_delayf)
);
...
DELAYG #(
	...
	// Outputs.
	.Z (maccore_ethphy_rx_data_delayf[0])
);
...
DELAYG #(
	...
	// Outputs.
	.Z (maccore_ethphy_rx_data_delayf[1])
);
...
DELAYG #(
	...
	// Outputs.
	.Z (maccore_ethphy_rx_data_delayf[2])
);
...
DELAYG #(
	...
	// Outputs.
	.Z (maccore_ethphy_rx_data_delayf[3])
);
...
ODDRX1F ODDRX1F_1(
	// Inputs.
	.D0   (maccore_ethphy_sink_valid),
	.D1   (maccore_ethphy_sink_valid),
	.SCLK (eth_tx_clk),

	// Outputs.
	.Q    (maccore_ethphy_tx_ctl_oddrx1f)
);
...
ODDRX1F ODDRX1F_2(
	// Inputs.
	.D0   (maccore_ethphy_sink_payload_data[0]),
	.D1   (maccore_ethphy_sink_payload_data[4]),
	.SCLK (eth_tx_clk),

	// Outputs.
	.Q    (maccore_ethphy_tx_data_oddrx1f[0])
);
...
ODDRX1F ODDRX1F_3(
	// Inputs.
	.D0   (maccore_ethphy_sink_payload_data[1]),
	.D1   (maccore_ethphy_sink_payload_data[5]),
	.SCLK (eth_tx_clk),

	// Outputs.
	.Q    (maccore_ethphy_tx_data_oddrx1f[1])
);
...
ODDRX1F ODDRX1F_4(
	// Inputs.
	.D0   (maccore_ethphy_sink_payload_data[2]),
	.D1   (maccore_ethphy_sink_payload_data[6]),
	.SCLK (eth_tx_clk),

	// Outputs.
	.Q    (maccore_ethphy_tx_data_oddrx1f[2])
);
...
ODDRX1F ODDRX1F_5(
	// Inputs.
	.D0   (maccore_ethphy_sink_payload_data[3]),
	.D1   (maccore_ethphy_sink_payload_data[7]),
	.SCLK (eth_tx_clk),

	// Outputs.
	.Q    (maccore_ethphy_tx_data_oddrx1f[3])
);
...
IDDRX1F IDDRX1F(
	// Inputs.
	.D    (maccore_ethphy_rx_ctl_delayf),
	.SCLK (eth_rx_clk),

	// Outputs.
	.Q0   (maccore_ethphy_rx_ctl[0]),
	.Q1   (maccore_ethphy_rx_ctl[1])
);
...
IDDRX1F IDDRX1F_1(
	// Inputs.
	.D    (maccore_ethphy_rx_data_delayf[0]),
	.SCLK (eth_rx_clk),

	// Outputs.
	.Q0   (maccore_ethphy_rx_data[0]),
	.Q1   (maccore_ethphy_rx_data[4])
);
...
IDDRX1F IDDRX1F_2(
	// Inputs.
	.D    (maccore_ethphy_rx_data_delayf[1]),
	.SCLK (eth_rx_clk),

	// Outputs.
	.Q0   (maccore_ethphy_rx_data[1]),
	.Q1   (maccore_ethphy_rx_data[5])
);
...
IDDRX1F IDDRX1F_3(
	// Inputs.
	.D    (maccore_ethphy_rx_data_delayf[2]),
	.SCLK (eth_rx_clk),

	// Outputs.
	.Q0   (maccore_ethphy_rx_data[2]),
	.Q1   (maccore_ethphy_rx_data[6])
);
...
IDDRX1F IDDRX1F_4(
	// Inputs.
	.D    (maccore_ethphy_rx_data_delayf[3]),
	.SCLK (eth_rx_clk),

	// Outputs.
	.Q0   (maccore_ethphy_rx_data[3]),
	.Q1   (maccore_ethphy_rx_data[7])
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-02-15 16:17:46.
//------------------------------------------------------------------------------
